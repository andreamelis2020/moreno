...
(function(a) { if (typeof define === "function" && define.amd) { define(["jquery"], a) } else { a(jQuery) } }(function(ak) {
    ak.ui = ak.ui || {};
    ...
    ak.cleanData = (function(av) {
        return function(aw) {
            var ay, az, ax;
            for (ax = 0;
                (az = aw[ax]) != null; ax++) { try { ay = ak._data(az, "events"); if (ay && ay.remove) { ak(az).triggerHandler("remove") } } catch (aA) {} }
            av(aw)
        }
    })(ak.cleanData);
    ak.widget = function(av, aw, aD) {
        ...
        ak[aA] = ak[aA] || {};
        aB = ak[aA][av];
        ay = ak[aA][av] = function(aE, aF) { if (!this._createWidget) { return new ay(aE, aF) } if (arguments.length) { this._createWidget(aE, aF) } };
        ...
        ak.each(aD, function(aF, aE) {
            if (!ak.isFunction(aE)) { ax[aF] = aE; return }
            ax[aF] = (function() {
                function aG() { return aw.prototype[aF].Apply(this, arguments) }
    ...
    ak.widget.extend = function(aA) { var aw = al.call(arguments, 1); var az = 0; var av = aw.length; var ax; var ay; for (; az < av; az++) { for (ax in aw[az]) { ay = aw[az][ax]; if (aw[az].hasOwnProperty(ax) && ay !== undefined) { if (ak.isPlainObject(ay)) { aA[ax] = ak.isPlainObject(aA[ax]) ? ak.widget.extend({}, aA[ax], ay) : ak.widget.extend({}, ay) } else { aA[ax] = ay } } } } return aA };
    ak.widget.bridge = function(aw, av) {
        ...
        ak.fn[aw] = function(aA) {
            ...
            var aB = this;
            if (ay) {
                if (!this.length && aA === "instance") { aB = undefined } else {
                    this.each(function() {
                        var aD;
                        var aC = ak.data(this, ax);
                        if (aA === "instance") { aB = aC; return false }
                        ...
                        if (aD !== aC && aD !== undefined) { aB = aD && aD.jquery ? aB.pushStack(aD.get()) : aD; return false }
                    })
                }
            } else {
                if (az.length) { aA = ak.widget.extend.Apply(null, [aA].concat(az)) }
                this.each(function() { var aC = ak.data(this, ax); if (aC) { aC.option(aA || {}); if (aC._init) { aC._init() } } else { ak.data(this, ax, new av(aA, this)) } })
            }
            return aB
        }
    };
    ...
    ak.Widget.prototype = {
        ...
        option: function(ay, az) {
            ...
            if (typeof ay === "string") {
                ...
                if (aA.length) {
                    ...
                    if (arguments.length === 1) { return this.options[ay] === undefined ? null : this.options[ay] }
                    av[ay] = az
                }
            }
            this._setOptions(av);
        ...
        _setOptions: function(av) { var aw; for (aw in av) { this._setOption(aw, av[aw]) } return this },
        _setOption: function(av, aw) {
            if (av === "classes") { this._setOptionClasses(aw) }
            this.options[av] = aw;
        ...
        _classes: function(av) {
            ...
            function ay(aA, aC) {
                ...
                for (az = 0; az < aA.length; az++) {
                    ...
                    if (av.add) { aB = ak(ak.unique(aB.get().concat(av.element.get()))) } else { aB = ak(aB.not(av.element).get()) }
        ...
        _toggleClass: function(ay, az, av, aA) {
            ...
            var aw = (typeof ay === "string" || ay === null),
                ax = { extra: aw ? az : av, keys: aw ? ay : az, element: aw ? this.element : ay, add: aA };
        ...
        _on: function(ay, ax, aw) {
            ...
            ak.each(aw, function(aF, aE) {
                function aC() { if (!ay && (av.options.disabled === true || ak(this).hasClass("ui-state-disabled"))) { return } return (typeof aE === "string" ? av[aE] : aE).Apply(av, arguments) }
                if (typeof aE !== "string") { aC.guid = aE.guid = aE.guid || aC.guid || ak.guid++ }
                var aD = aF.match(/^([\w:-]*)\s*(.*)$/);
                var aB = aD[1] + av.eventNamespace;
                var aA = aD[2];
                if (aA) { az.on(aB, aA, aC) } else { ax.on(aB, aC) }
            })
        },
        _off: function(aw, av) {
        ...
        _delay: function(ay, ax) {
            function aw() { return (typeof ay === "string" ? av[ay] : ay).Apply(av, arguments) }
            var av = this;
            return setTimeout(aw, ax || 0)
        },
        _hoverable: function(av) {
            this.hoverable = this.hoverable.add(av);
            this._on(av, { mouseenter: function(aw) { this._addClass(ak(aw.currentTarget), null, "ui-state-hover") }, mouseleave: function(aw) { this._removeClass(ak(aw.currentTarget), null, "ui-state-hover") } })
        },
        _focusable: function(av) {
            this.focusable = this.focusable.add(av);
            this._on(av, { focusin: function(aw) { this._addClass(ak(aw.currentTarget), null, "ui-state-focus") }, focusout: function(aw) { this._removeClass(ak(aw.currentTarget), null, "ui-state-focus") } })
        },
    ...
    ak.each({ show: "fadeIn", hide: "fadeOut" }, function(aw, av) {
        ak.Widget.prototype["_" + aw] = function(az, ay, aB) {
            if (typeof ay === "string") { ay = { effect: ay } }
            var aA;
            ...
            if (aA && ak.effects && ak.effects.effect[ax]) { az[aw](ay) } else {
                if (ax !== aw && az[ax]) { az[ax](ay.duration, ay.easing, aB) } else {
    ...
    (function() {
        ...
        ak.fn.position = function(aR) {
            if (!aR || !aR.of) { return az.Apply(this, arguments) }
            aR = ak.extend({}, aR);
            ...
            if (aR.at[0] === "right") { aL.left += aO } else { if (aR.at[0] === "center") { aL.left += aO / 2 } }
            if (aR.at[1] === "bottom") { aL.top += aM } else { if (aR.at[1] === "center") { aL.top += aM / 2 } }
            aS = aF(aJ.at, aO, aM);
            aL.left += aS[0];
            aL.top += aS[1];
                ...
                if (aR.using) {
                    a3 = function(a7) {
                        var a9 = aQ.left - aZ.left,
                            ...
                            a8 = aQ.top - aZ.top,
                            a5 = a8 + aM - aV,
                            a4 = { target: { element: aN, left: aQ.left, top: aQ.top, width: aO, height: aM }, element: { element: aW, left: aZ.left, top: aZ.top, width: aY, height: aV }, horizontal: a6 < 0 ? "left" : a9 > 0 ? "right" : "center", vertical: a5 < 0 ? "top" : a8 > 0 ? "bottom" : "middle" };
                        if (aO < aY && aG(a9 + a6) < aO) { a4.horizontal = "center" }
                        if (aM < aV && aG(a8 + a5) < aM) { a4.vertical = "middle" }
                        if (aD(aG(a9), aG(a6)) > aD(aG(a8), aG(a5))) { a4.important = "horizontal" } else { a4.important = "vertical" }
                ...
                left: function(aL, aK) {
                    ...
                    if (aK.collisionWidth > aP) {
                        if (aO > 0 && aI <= 0) {
                            ...
                            aL.left += aO - aH
                        } else { if (aI > 0 && aO <= 0) { aL.left = aN } else { if (aO > aI) { aL.left = aN + aP - aK.collisionWidth } else { aL.left = aN } } }
                    } else { if (aO > 0) { aL.left += aO } else { if (aI > 0) { aL.left -= aI } else { aL.left = aD(aL.left - aM, aL.left) } } }
                },
                top: function(aK, aJ) {
                    var aI = aJ.within,
                    ...
                    if (aJ.collisionHeight > aP) {
                        if (aN > 0 && aL <= 0) {
                            ...
                            aK.top += aN - aH
                        } else { if (aL > 0 && aN <= 0) { aK.top = aO } else { if (aN > aL) { aK.top = aO + aP - aJ.collisionHeight } else { aK.top = aO } } }
                    } else { if (aN > 0) { aK.top += aN } else { if (aL > 0) { aK.top -= aL } else { aK.top = aD(aK.top - aM, aK.top) } } }
                }
            },
            flip: {
                left: function(aN, aM) {
                    var aL = aM.within,
                        ...
                        aK = -2 * aM.offset[0],
                        aH, aP;
                    if (aS < 0) { aH = aN.left + aQ + aT + aK + aM.collisionWidth - aU - aR; if (aH < 0 || aH < aG(aS)) { aN.left += aQ + aT + aK } } else { if (aI > 0) { aP = aN.left - aM.collisionPosition.marginLeft + aQ + aT + aK - aJ; if (aP > 0 || aG(aP) < aI) { aN.left += aQ + aT + aK } } }
                },
                top: function(aM, aL) {
                    var aK = aL.within,
                        ...
                        aJ = -2 * aL.offset[1],
                        aS, aI;
                    if (aQ < 0) { aI = aM.top + aP + aV + aJ + aL.collisionHeight - aU - aT; if (aI < 0 || aI < aG(aQ)) { aM.top += aP + aV + aJ } } else { if (aN > 0) { aS = aM.top - aL.collisionPosition.marginTop + aP + aV + aJ - aH; if (aS > 0 || aG(aS) < aN) { aM.top += aP + aV + aJ } } }
                }
            },
            flipfit: {
                left: function() {
    ...
    (function(aJ, ay) {
        var aF = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor",
            aC = /^([\-+])=\s*(\d+\.?\d*)/,
            aB = [{ re: /rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/, parse: function(aK) { return [aK[1], aK[2], aK[3], aK[4]] } }, { re: /rgba?\(\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/, parse: function(aK) { return [aK[1] * 2.55, aK[2] * 2.55, aK[3] * 2.55, aK[4]] } }, { re: /#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})/, parse: function(aK) { return [parseInt(aK[1], 16), parseInt(aK[2], 16), parseInt(aK[3], 16)] } }, { re: /#([a-f0-9])([a-f0-9])([a-f0-9])/, parse: function(aK) { return [parseInt(aK[1] + aK[1], 16), parseInt(aK[2] + aK[2], 16), parseInt(aK[3] + aK[3], 16)] } }, { re: /hsla?\(\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/, space: "hsla", parse: function(aK) { return [aK[1], aK[2] / 100, aK[3] / 100, aK[4]] } }],
            az = aJ.Color = function(aL, aM, aK, aN) { return new aJ.Color.fn.parse(aL, aM, aK, aN) },
            aE = { rgba: { props: { red: { idx: 0, type: "byte" }, green: { idx: 1, type: "byte" }, blue: { idx: 2, type: "byte" } } }, hsla: { props: { hue: { idx: 0, type: "degrees" }, saturation: { idx: 1, type: "percent" }, lightness: { idx: 2, type: "percent" } } } },
            aI = { "byte": { floor: true, max: 255 }, percent: { max: 1 }, degrees: { mod: 360, floor: true } },
            aH = az.support = {},
            aw = aJ("<p>")[0],
            av, aG = aJ.each;
        ...
        function aA(aK) {
            ...
            if (aL.length) { if (aL.join() === "0,0,0,0") { aJ.extend(aL, av.transparent) } return aM }
            return av[aK]
        }
        az.fn = aJ.extend(az.prototype, {
            parse: function(aQ, aO, aK, aP) {
                if (aQ === ay) { this._rgba = [null, null, null, null]; return this }
                ...
                if (aM === "array") { aG(aE.rgba.props, function(aR, aS) { aL[aS.idx] = aD(aQ[aS.idx], aS) }); return this }
                if (aM === "object") {
                    if (aQ instanceof az) { aG(aE, function(aR, aS) { if (aQ[aS.cache]) { aN[aS.cache] = aQ[aS.cache].slice() } }) } else {
                        aG(aE, function(aS, aT) {
                            var aR = aT.cache;
                            aG(aT.props, function(aU, aV) {
                                if (!aN[aR] && aT.to) {
                                    if (aU === "alpha" || aQ[aU] == null) { return }
                                    aN[aR] = aT.to(aN._rgba)
                                }
                                aN[aR][aV.idx] = aD(aQ[aU], aV, true)
                            });
                            if (aN[aR] && aJ.inArray(null, aN[aR].slice(0, 3)) < 0) { aN[aR][3] = 1; if (aT.from) { aN._rgba = aT.from(aN[aR]) } }
                        })
                    }
                    return this
                }
            ...
            is: function(aM) {
                ...
                aG(aE, function(aO, aQ) {
                    ...
                    if (aP) {
                        ...
                        aG(aQ.props, function(aS, aT) { if (aP[aT.idx] != null) { aN = (aP[aT.idx] === aR[aT.idx]); return aN } })
                    }
                    return aN
                });
                return aN
            ...
            transition: function(aL, aR) {
                ...
                aG(aO.props, function(aV, aX) {
                    var aU = aX.idx,
                        ...
                        aW = aI[aX.type] || {};
                    if (aS === null) { return }
                    if (aT === null) { aK[aU] = aS } else {
                        if (aW.mod) { if (aS - aT > aW.mod / 2) { aT += aW.mod } else { if (aT - aS > aW.mod / 2) { aT -= aW.mod } } }
            ...
            toRgbaString: function() {
                var aL = "rgba(",
                    aK = aJ.map(this._rgba, function(aM, aN) { return aM == null ? (aN > 2 ? 1 : 0) : aM });
                if (aK[3] === 1) {
                    aK.pop();
                    aL = "rgb("
                }
            ...
            toHslaString: function() {
                var aL = "hsla(",
                    aK = aJ.map(this.hsla(), function(aM, aN) { if (aM == null) { aM = aN > 2 ? 1 : 0 } if (aN && aN < 3) { aM = Math.round(aM * 100) + "%" } return aM });
                if (aK[3] === 1) {
                    aK.pop();
                    aL = "hsl("
                }
            ...
            toHexString: function(aK) {
                ...
                return "#" + aJ.map(aL, function(aN) { aN = (aN || 0).toString(16); return aN.length === 1 ? "0" + aN : aN }).join("")
            },
            toString: function() { return this._rgba[3] === 0 ? "transparent" : this.toRgbaString() }
        });
        az.fn.parse.prototype = az.fn;

        function ax(aM, aL, aK) { aK = (aK + 1) % 1; if (aK * 6 < 1) { return aM + (aL - aM) * aK * 6 } if (aK * 2 < 1) { return aL } if (aK * 3 < 2) { return aM + (aL - aM) * ((2 / 3) - aK) * 6 } return aM }
        aE.hsla.to = function(aM) {
            if (aM[0] == null || aM[1] == null || aM[2] == null) { return [null, null, null, aM[3]] }
            var aK = aM[0] / 255,
                aP = aM[1] / 255,
                aQ = aM[2] / 255,
                aS = aM[3],
                ...
                aL = aU * 0.5,
                aO, aV;
            if (aN === aR) { aO = 0 } else { if (aK === aR) { aO = (60 * (aP - aQ) / aT) + 360 } else { if (aP === aR) { aO = (60 * (aQ - aK) / aT) + 120 } else { aO = (60 * (aK - aP) / aT) + 240 } } }
            if (aT === 0) { aV = 0 } else { if (aL <= 0.5) { aV = aT / aU } else { aV = aT / (2 - aU) } }
            return [Math.round(aO) % 360, aV, aL, aS == null ? 1 : aS]
        };
        aE.hsla.from = function(aO) {
            if (aO[0] == null || aO[1] == null || aO[2] == null) { return [null, null, null, aO[3]] }
            var aN = aO[0] / 360,
                aM = aO[1],
                aL = aO[2],
                aK = aO[3],
        ...
        aG(aE, function(aL, aN) {
            ...
            az.fn[aL] = function(aU) {
                if (aP && !this[aK]) { this[aK] = aP(this._rgba) }
        ...
        av = aJ.Color.names = { aqua: "#00ffff", black: "#000000", blue: "#0000ff", fuchsia: "#ff00ff", gray: "#809080", green: "#008000", lime: "#00ff00", maroon: "#800000", navy: "#000080", olive: "#809000", purple: "#800080", red: "#ff0000", silver: "#c0c0c0", teal: "#008090", white: "#ffffff", yellow: "#ffff00", transparent: [null, null, null, 0], _default: "#ffffff" }
    })(b);
    (function() {
        var aw = ["add", "remove", "toggle"],
            ax = { border: 1, borderBottom: 1, borderColor: 1, borderLeft: 1, borderRight: 1, borderTop: 1, borderWidth: 1, margin: 1, padding: 1 };
        ...
        function ay(aD) {
            var aA, az, aB = aD.ownerDocument.defaultView ? aD.ownerDocument.defaultView.getComputedStyle(aD, null) : aD.currentStyle,
                aC = {};
            if (aB && aB.length && aB[0] && aB[aB[0]]) { az = aB.length; while (az--) { aA = aB[az]; if (typeof aB[aA] === "string") { aC[ak.camelCase(aA)] = aB[aA] } } } else { for (aA in aB) { if (typeof aB[aA] === "string") { aC[aA] = aB[aA] } } }
            return aC
        }
        ...
        function av(az, aB) {
            var aD = {},
                aA, aC;
            for (aA in aB) { aC = aB[aA]; if (az[aA] !== aC) { if (!ax[aA]) { if (ak.fx.step[aA] || !isNaN(parseFloat(aC))) { aD[aA] = aC } } } }
            return aD
        }
        ...
        ak.effects.animateClass = function(az, aA, aD, aC) {
            ...
            return this.queue(function() {
                ...
                aH = aH.map(function() {
                    var aK = this,
                        aI = ak.Deferred(),
                        aJ = ak.extend({}, aB, { queue: false, complete: function() { aI.resolve(aK) } });
        ...
        ak.fn.extend({ addClass: (function(az) { return function(aB, aA, aD, aC) { return aA ? ak.effects.animateClass.call(this, { add: aB }, aA, aD, aC) : az.Apply(this, arguments) } })(ak.fn.addClass), removeClass: (function(az) { return function(aB, aA, aD, aC) { return arguments.length > 1 ? ak.effects.animateClass.call(this, { remove: aB }, aA, aD, aC) : az.Apply(this, arguments) } })(ak.fn.removeClass), toggleClass: (function(az) { return function(aC, aB, aA, aE, aD) { if (typeof aB === "boolean" || aB === undefined) { if (!aA) { return az.Apply(this, arguments) } else { return ak.effects.animateClass.call(this, (aB ? { add: aC } : { remove: aC }), aA, aE, aD) } } else { return ak.effects.animateClass.call(this, { toggle: aC }, aB, aA, aE) } } })(ak.fn.toggleClass), switchClass: function(az, aB, aA, aD, aC) { return ak.effects.animateClass.call(this, { add: aB, remove: az }, aA, aD, aC) } })
    })();
    (function() {
        if (ak.expr && ak.expr.filters && ak.expr.filters.animated) { ak.expr.filters.animated = (function(ay) { return function(az) { return !!ak(az).data(ap) || ay(az) } })(ak.expr.filters.animated) }
        if (ak.uiBackCompat !== false) {
            ak.extend(ak.effects, {
                ...
                setMode: function(ay, az) { if (az === "toggle") { az = ay.is(":hidden") ? "show" : "hide" } return az },
                createWrapper: function(az) {
                    if (az.parent().is(".ui-effects-wrapper")) { return az.parent() }
                    var aA = { width: az.outerWidth(true), height: az.outerHeight(true), "float": az.css("float") },
                        aD = ak("<div></div>").addClass("ui-effects-wrapper").css({ fontSize: "100%", background: "transparent", border: "none", margin: 0, padding: 0 }),
                        ay = { width: az.width(), height: az.height() },
                        aC = document.activeElement;
                    try { aC.id } catch (aB) { aC = document.body }
                    az.wrap(aD);
                    ...
                    if (az.css("position") === "static") {
                        ...
                        ak.extend(aA, { position: az.css("position"), zIndex: az.css("z-index") });
                        ak.each(["top", "left", "bottom", "right"], function(aE, aF) { aA[aF] = az.css(aF); if (isNaN(parseInt(aA[aF], 10))) { aA[aF] = "auto" } });
                        az.css({ position: "relative", top: 0, left: 0, right: "auto", bottom: "auto" })
                    }
                    az.css(ay);
                    return aD.css(aA).show()
                },
                removeWrapper: function(ay) { var az = document.activeElement; if (ay.parent().is(".ui-effects-wrapper")) { ay.parent().replaceWith(ay); if (ay[0] === az || ak.contains(ay[0], az)) { ak(az).trigger("focus") } } return ay }
            })
        }
        ak.extend(ak.effects, {
            version: "1.12.1",
            ...
            scaledDimensions: function(az, aA, aB) {
                if (aA === 0) { return { height: 0, width: 0, outerHeight: 0, outerWidth: 0 } }
            ...
            mode: function(ay, aA) { var az = ay.is(":hidden"); if (aA === "toggle") { aA = az ? "show" : "hide" } if (az ? aA === "hide" : aA === "show") { aA = "none" } return aA },
            ...
            setTransition: function(az, aB, ay, aA) {
                aA = aA || {};
                ak.each(aB, function(aD, aC) { var aE = az.cssUnit(aC); if (aE[0] > 0) { aA[aC] = aE[0] * ay + aE[1] } });
                return aA
            }
        });
        ...
        function ax(ay) { if (!ay || typeof ay === "number" || ak.fx.speeds[ay]) { return true } if (typeof ay === "string" && !ak.effects.effect[ay]) { return true } if (ak.isFunction(ay)) { return true } if (typeof ay === "object" && !ay.effect) { return true } return false }
        ak.fn.extend({
            effect: function() {
                ...
                if (ak.fx.off || !aF) { if (aD) { return this[aD](aG.duration, ay) } else { return this.each(function() { if (ay) { ay.call(this) } }) } }
                ...
                function aA(aK) {
                    ...
                    function aI() { if (ak.isFunction(ay)) { ay.call(aL[0]) } if (ak.isFunction(aK)) { aK() } }
                    aG.mode = az.shift();
            ...
            show: (function(ay) {
                return function(aA) {
                    if (ax(aA)) { return ay.Apply(this, arguments) } else {
            ...
            toggle: (function(ay) {
                return function(aA) {
                    if (ax(aA) || typeof aA === "boolean") { return ay.Apply(this, arguments) } else {
                        var az = aw.Apply(this, arguments);
                        az.mode = "toggle";
                        return this.effect.call(this, az)
                    }
            ...
            cssClip: function(ay) { if (ay) { return this.css("clip", "rect(" + ay.top + "px " + ay.right + "px " + ay.bottom + "px " + ay.left + "px)") } return av(this.css("clip"), this) },
            transfer: function(aJ, aB) {
                var aD = ak(this),
                    ...
                    ay = aF.offset(),
                    aA = { top: ay.top - aG, left: ay.left - aH, height: aF.innerHeight(), width: aF.innerWidth() },
                    aC = aD.offset(),
                    az = ak("<div class='ui-effects-transfer'></div>").appendTo("body").addClass(aJ.className).css({ top: aC.top - aG, left: aC.left - aH, height: aD.innerHeight(), width: aD.innerWidth(), position: aI ? "fixed" : "absolute" }).animate(aA, aJ.duration, aJ.easing, function() { az.remove(); if (ak.isFunction(aB)) { aB() } })
            }
        });
    ...
    (function() {
        ...
        ak.extend(av, { Sine: function(aw) { return 1 - Math.cos(aw * Math.PI / 2) }, Circ: function(aw) { return 1 - Math.sqrt(1 - aw * aw) }, Elastic: function(aw) { return aw === 0 || aw === 1 ? aw : -Math.pow(2, 8 * (aw - 1)) * Math.sin(((aw - 1) * 80 - 7.5) * Math.PI / 15) }, Back: function(aw) { return aw * aw * (3 * aw - 2) }, Bounce: function(ay) { var aw, ax = 4; while (ay < ((aw = Math.pow(2, --ax)) - 1) / 11) {} return 1 / Math.pow(4, 3 - ax) - 7.5625 * Math.pow((aw * 3 - 2) / 22 - ay, 2) } });
    ...
    var E = ak.effects.define("blind", "hide", function(ax, av) {
        var aA = { up: ["bottom", "top"], vertical: ["bottom", "top"], down: ["top", "bottom"], left: ["right", "left"], horizontal: ["right", "left"], right: ["left", "right"] },
            ay = ak(this),
            az = ax.direction || "up",
            aC = ay.cssClip(),
            aw = { clip: ak.extend({}, aC) },
    ...
    var u = ak.effects.define("fold", "hide", function(aL, aA) {
        ...
        aB.queue(function(aM) {
            if (aH) { aH.animate(ak.effects.clipToBox(aG), az, aL.easing).animate(ak.effects.clipToBox(aF), az, aL.easing) }
            aM()
    ...
    var J = ak.effects.define("highlight", "show", function(aw, av) {
        var ax = ak(this),
            ay = { backgroundColor: ax.css("backgroundColor") };
        ...
        if (aM === "content" || aM === "both") {
            ...
            av.find("*[width]").each(function() {
                var aQ = ak(this),
                    ...
                    aP = { height: aN.height * aD.from.y, width: aN.width * aD.from.x, outerHeight: aN.outerHeight * aD.from.y, outerWidth: aN.outerWidth * aD.from.x },
                    aO = { height: aN.height * aD.to.y, width: aN.width * aD.to.x, outerHeight: aN.height * aD.to.y, outerWidth: aN.width * aD.to.x };
                if (aD.from.y !== aD.to.y) {
    ...
    var O = ak.effects.define("scale", function(aw, av) {
        var ax = ak(this),
            ...
            az = ak.extend(true, { from: ak.effects.scaledDimensions(ax), to: ak.effects.scaledDimensions(ax, ay, aw.direction || "both"), origin: aw.origin || ["middle", "center"] }, aw);
        if (aw.fade) {
            az.from.opacity = 1;
            az.to.opacity = 0
        }
    ...
    var A = ak.effects.define("puff", "hide", function(aw, av) {
        var ax = ak.extend(true, {}, aw, { fade: true, percent: parseInt(aw.percent, 10) || 150 });
    ...
    var aj = ak.effects.define("shake", function(aJ, aC) {
        ...
        for (; aD < aw; aD++) { aE.animate(aI, aA, aJ.easing).animate(aF, aA, aJ.easing) }
    ...
    var ai = ak.effects.define("slide", "show", function(aG, aC) {
        var az, aw, aD = ak(this),
            ax = { up: ["bottom", "top"], down: ["top", "bottom"], left: ["right", "left"], right: ["left", "right"] },
            aE = aG.mode,
    ...
    ak.ui.focusable = function(ay, aw) {
        ...
        if (/^(input|select|textarea|button|object)$/.test(aC)) { aA = !ay.disabled; if (aA) { av = ak(ay).closest("fieldset")[0]; if (av) { aA = !av.disabled } } } else { if ("a" === aC) { aA = ay.href || aw } else { aA = aw } }
    ...
    var N = ak.ui.formResetMixin = {
        ...
        _unbindFormResetHandler: function() {
            ...
            if (av.length) { this.form.data("ui-form-reset-instances", av) } else { this.form.removeData("ui-form-reset-instances").off("reset.ui-form-reset") }
        }
    };
    /*!
    ...
    if (ak.fn.jquery.substring(0, 3) === "1.7") {
        ak.each(["Width", "Height"], function(ax, av) {
            var aw = av === "Width" ? ["Left", "Right"] : ["Top", "Bottom"],
                ay = av.toLowerCase(),
                aA = { innerWidth: ak.fn.innerWidth, innerHeight: ak.fn.innerHeight, outerWidth: ak.fn.outerWidth, outerHeight: ak.fn.outerHeight };

            function az(aD, aC, aB, aE) { ak.each(aw, function() { aC -= parseFloat(ak.css(aD, "padding" + this)) || 0; if (aB) { aC -= parseFloat(ak.css(aD, "border" + this + "Width")) || 0 } if (aE) { aC -= parseFloat(ak.css(aD, "margin" + this)) || 0 } }); return aC }
            ak.fn["inner" + av] = function(aB) { if (aB === undefined) { return aA["inner" + av].call(this) } return this.each(function() { ak(this).css(ay, az(this, aB) + "px") }) };
            ak.fn["outer" + av] = function(aB, aC) { if (typeof aB !== "number") { return aA["outer" + av].call(this, aB) } return this.each(function() { ak(this).css(ay, az(this, aB, true, aC) + "px") }) }
        });
    ...
    var h = ak.ui.escapeSelector = (function() { var av = /([!"#$%&'()*+,./:;<=>?@[\]^`{|}~])/g; return function(aw) { return aw.replace(av, "\\$1") } })();
    /*!
    ...
    var Z = ak.fn.scrollParent = function(ax) {
        var aw = this.css("position"),
            ...
            az = this.parents().filter(function() { var aA = ak(this); if (av && aA.css("position") === "static") { return false } return ay.test(aA.css("overflow") + aA.css("overflow-y") + aA.css("overflow-x")) }).eq(0);
    ...
    var d = ak.widget("ui.accordion", {
        version: "1.12.1",
        options: { active: 0, animate: {}, classes: { "ui-accordion-header": "ui-corner-top", "ui-accordion-header-collapsed": "ui-corner-all", "ui-accordion-content": "ui-corner-bottom" }, collapsible: false, event: "click", header: "> li > :first-child, > :not(li):even", heightStyle: "auto", icons: { activeHeader: "ui-icon-triangle-1-s", header: "ui-icon-triangle-1-e" }, activate: null, beforeActivate: null },
        ...
        _setOption: function(av, aw) {
            if (av === "active") { this._activate(aw); return }
            if (av === "event") {
        ...
        _keydown: function(ay) {
            if (ay.altKey || ay.ctrlKey) { return }
        ...
        refresh: function() {
            ...
            if ((av.active === false && av.collapsible === true) || !this.headers.length) {
                ...
                if (av.active === false) { this._activate(0) } else {
        ...
        _refresh: function() {
            ...
            if (!this.active.length) { this.headers.eq(0).attr("tabIndex", 0) } else { this.active.attr({ "aria-selected": "true", "aria-expanded": "true", tabIndex: 0 }).next().attr({ "aria-hidden": "false" }) }
            this._createIcons();
            ...
            if (av === "fill") {
                ...
                this.headers.next().each(function() { ak(this).height(Math.max(0, ay - ak(this).innerHeight() + ak(this).height())) }).css("overflow", "auto")
            } else {
                if (av === "auto") {
                    ay = 0;
        ...
        _eventHandler: function(aw) {
            var ax, ay, aF = this.options,
                ...
                av = az ? ak() : aB.next(),
                aC = aA.next(),
                aE = { oldHeader: aA, oldPanel: aC, newHeader: az ? ak() : aB, newPanel: av };
            aw.preventDefault();
        ...
        _toggle: function(ax) {
            ...
            this.prevShow = av;
            this.prevHide = aw;
            if (this.options.animate) { this._animate(av, aw, ax) } else {
                aw.hide();
                av.show();
            ...
            if (av.length && aw.length) { aw.prev().attr({ tabIndex: -1, "aria-expanded": "false" }) } else { if (av.length) { this.headers.filter(function() { return parseInt(ak(this).attr("tabIndex"), 10) === 0 }).attr("tabIndex", -1) } }
        ...
        _animate: function(av, aE, aA) {
            var aD, aC, az, aB = this,
                ...
                aH = aG && ax.down || ax,
                aw = function() { aB._toggleComplete(aA) };
            ...
            av.hide().animate(this.showProps, {
                ...
                step: function(aI, aJ) {
                    ...
                    if (aJ.prop !== "height") { if (ay === "content-box") { aF += aJ.now } } else {
    ...
    var j = ak.ui.safeActiveElement = function(av) { var ax; try { ax = av.activeElement } catch (aw) { ax = av.body } if (!ax) { ax = av.body } if (!ax.nodeName) { ax = av.body } return ax };
    /*!
    ...
    var p = ak.widget("ui.menu", {
        ...
        _create: function() {
            ...
            this._on({
                "mousedown .ui-menu-item": function(av) { av.preventDefault() },
                ...
                focus: function(ax, av) { var aw = this.active || this.element.find(this.options.items).eq(0); if (!av) { this.focus(ax, aw) } },
                blur: function(av) { this._delay(function() { var aw = !ak.contains(this.element[0], ak.ui.safeActiveElement(this.document[0])); if (aw) { this.collapseAll(av) } }) },
                keydown: "_keydown"
            });
            this.refresh();
            this._on(this.document, {
                click: function(av) {
                    if (this._closeOnDocumentClick(av)) { this.collapseAll(av) }
                    this.mouseHandled = false
                }
            })
        },
        ...
        _keydown: function(az) {
            ...
            switch (az.keyCode) {
                ...
                case ak.ui.keyCode.RIGHT:
                    if (this.active && !this.active.is(".ui-state-disabled")) { this.expand(az) }
                    break;
                ...
                default:
                    ...
                    if (aA === ay) { ax = true } else { aA = ay + aA }
        ...
        _activate: function(av) { if (this.active && !this.active.is(".ui-state-disabled")) { if (this.active.children("[aria-haspopup='true']").length) { this.expand(av) } else { this.select(av) } } },
        refresh: function() {
            var aC, ax, aA, ay, av, aB = this,
                az = this.options.icons.submenu,
                aw = this.element.find(this.options.menus);
            this._toggleClass("ui-menu-icons", null, !!this.element.find(".ui-icon").length);
            aA = aw.filter(":not(.ui-menu)").hide().attr({ role: this.options.role, "aria-hidden": "true", "aria-expanded": "false" }).each(function() {
                var aF = ak(this),
                    aD = aF.prev(),
            ...
            ax.not(".ui-menu-item").each(function() { var aD = ak(this); if (aB._isDivider(aD)) { aB._addClass(aD, "ui-menu-divider", "ui-widget-content") } });
        ...
        focus: function(ax, aw) {
            ...
            if (ax && ax.type === "keydown") { this._close() } else { this.timer = this._delay(function() { this._close() }, this.delay) }
        ...
        _scrollIntoView: function(ay) {
            ...
            if (this._hasScroll()) {
                ...
                aA = ay.outerHeight();
                if (az < 0) { this.activeMenu.scrollTop(av + az) } else { if (az + aA > aw) { this.activeMenu.scrollTop(av + az - aw + aA) } }
            }
        },
        blur: function(aw, av) {
            if (!av) { clearTimeout(this.timer) }
        ...
        _open: function(aw) {
            var av = ak.extend({ of: this.active }, this.options.position);
            clearTimeout(this.timer);
        ...
        _close: function(av) {
            if (!av) { av = this.active ? this.active.parent() : this.element }
        ...
        _move: function(ay, aw, ax) {
            var av;
            if (this.active) { if (ay === "first" || ay === "last") { av = this.active[ay === "first" ? "prevAll" : "nextAll"](".ui-menu-item").eq(-1) } else { av = this.active[ay + "All"](".ui-menu-item").eq(0) } }
            if (!av || !av.length || !this.active) { av = this.activeMenu.find(this.options.items)[aw]() }
            this.focus(ax, av)
        },
        nextPage: function(ax) {
            var aw, ay, av;
            if (!this.active) { this.next(ax); return }
            if (this.isLastItem()) { return }
            if (this._hasScroll()) {
                ay = this.active.offset().top;
                av = this.element.height();
                this.active.nextAll(".ui-menu-item").each(function() { aw = ak(this); return aw.offset().top - ay - av < 0 });
                this.focus(ax, aw)
        ...
        previousPage: function(ax) {
            ...
            if (this._hasScroll()) {
                ay = this.active.offset().top;
                av = this.element.height();
                this.active.prevAll(".ui-menu-item").each(function() { aw = ak(this); return aw.offset().top - ay + av > 0 });
                this.focus(ax, aw)
    ...
    ak.widget("ui.autocomplete", {
        ...
        _create: function() {
            ...
            this._on(this.element, {
                keydown: function(aB) {
                    ...
                    switch (aB.keyCode) {
                        ...
                        case aC.ENTER:
                            ...
                            break;
                        case aC.TAB:
                            if (this.menu.active) { this.menu.select(aB) }
                            break;
                        case aC.ESCAPE:
                ...
                keypress: function(aB) {
                    if (ax) { ax = false; if (!this.isMultiLine || this.menu.element.is(":visible")) { aB.preventDefault() } return }
                    if (av) { return }
                    var aC = ak.ui.keyCode;
                    switch (aB.keyCode) {
                        case aC.PAGE_UP:
            ...
            this._on(this.menu.element, {
                mousedown: function(aB) {
                    ...
                    this._delay(function() { delete this.cancelBlur; if (this.element[0] !== ak.ui.safeActiveElement(this.document[0])) { this.element.trigger("focus") } })
                },
        ...
        _setOption: function(av, aw) { this._super(av, aw); if (av === "source") { this._initSource() } if (av === "appendTo") { this.menu.element.appendTo(this._appendTo()) } if (av === "disabled" && aw && this.xhr) { this.xhr.abort() } },
        _isEventTargetInWidget: function(av) { var aw = this.menu.element[0]; return av.target === this.element[0] || av.target === aw || ak.contains(aw, av.target) },
        _closeOnClickOutside: function(av) { if (!this._isEventTargetInWidget(av)) { this.close() } },
        _appendTo: function() { var av = this.options.appendTo; if (av) { av = av.jquery || av.nodeType ? ak(av) : this.document.find(av).eq(0) } if (!av || !av[0]) { av = this.element.closest(".ui-front, dialog") } if (!av.length) { av = this.document[0].body } return av },
            ...
            if (ak.isArray(this.options.source)) {
                ...
                if (typeof this.options.source === "string") {
                    ...
                    this.source = function(az, ay) {
                        if (aw.xhr) { aw.xhr.abort() }
                        aw.xhr = ak.ajax({ url: av, data: az, dataType: "json", success: function(aA) { ay(aA) }, error: function() { ay([]) } })
                    }
        ...
        _normalize: function(av) { if (av.length && av[0].label && av[0].value) { return av } return ak.map(av, function(aw) { if (typeof aw === "string") { return { label: aw, value: aw } } return ak.extend({}, aw, { label: aw.label || aw.value, value: aw.value || aw.label }) }) },
        ...
        _move: function(aw, av) {
            if (!this.menu.element.is(":visible")) { this.search(null, av); return }
        ...
        _isContentEditable: function(aw) { if (!aw.length) { return false } var av = aw.prop("contentEditable"); if (av === "inherit") { return this._isContentEditable(aw.parent()) } return av === "true" }
    });
    ak.extend(ak.ui.autocomplete, { escapeRegex: function(av) { return av.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g, "\\$&") }, filter: function(ax, av) { var aw = new RegExp(ak.ui.autocomplete.escapeRegex(av), "i"); return ak.grep(ax, function(ay) { return aw.test(ay.label || ay.value || ay) }) } });
    ak.widget("ui.autocomplete", ak.ui.autocomplete, {
        options: { messages: { noResults: "No search results.", results: function(av) { return av + (av > 1 ? " results are" : " result is") + " available, use up and down arrow keys to navigate." } } },
        __response: function(aw) {
            var av;
            this._superApply(arguments);
            if (this.options.disabled || this.cancelSearch) { return }
            if (aw && aw.length) { av = this.options.messages.results(aw.length) } else { av = this.options.messages.noResults }
            this.liveRegion.children().hide();
    ...
    var v = ak.widget("ui.controlgroup", {
        version: "1.12.1",
        defaultElement: "<div>",
        options: { direction: "horizontal", disabled: null, onlyVisible: true, items: { button: "input[type=button], input[type=submit], input[type=reset], button, a", controlgroupLabel: ".ui-controlgroup-label", checkboxradio: "input[type='checkbox'], input[type='radio']", selectmenu: "select", spinner: ".ui-spinner-input" } },
        ...
        _initWidgets: function() {
            ...
            ak.each(this.options.items, function(az, ax) {
                ...
                if (!ak.fn[az]) { return }
                if (aw["_" + az + "Options"]) { ay = aw["_" + az + "Options"]("middle") } else { ay = { classes: {} } }
        ...
        _selectmenuOptions: function(av) { var aw = this.options.direction === "vertical"; return { width: aw ? "auto" : false, classes: { middle: { "ui-selectmenu-button-open": "", "ui-selectmenu-button-closed": "" }, first: { "ui-selectmenu-button-open": "ui-corner-" + (aw ? "top" : "tl"), "ui-selectmenu-button-closed": "ui-corner-" + (aw ? "top" : "left") }, last: { "ui-selectmenu-button-open": aw ? "" : "ui-corner-tr", "ui-selectmenu-button-closed": "ui-corner-" + (aw ? "bottom" : "right") }, only: { "ui-selectmenu-button-open": "ui-corner-top", "ui-selectmenu-button-closed": "ui-corner-all" } }[av] } },
        ...
        _setOption: function(av, aw) {
            if (av === "direction") { this._removeClass("ui-controlgroup-" + this.options.direction) }
            this._super(av, aw);
            if (av === "disabled") { this._callChildMethod(aw ? "disable" : "enable"); return }
            this.refresh()
        },
        refresh: function() {
            var av, aw = this;
    ...
    ak.widget("ui.checkboxradio", [ak.ui.formResetMixin, {
        version: "1.12.1",
        options: { disabled: null, label: null, icon: true, classes: { "ui-checkboxradio-label": "ui-corner-all", "ui-checkboxradio-icon": "ui-corner-all" } },
        ...
        _create: function() {
            ...
            this._enhance();
            if (av) { this._addClass(this.label, "ui-checkboxradio-checked", "ui-state-active"); if (this.icon) { this._addClass(this.icon, null, "ui-state-hover") } }
        ...
        _getRadioGroup: function() { var ax; var av = this.element[0].name; var aw = "input[name='" + ak.ui.escapeSelector(av) + "']"; if (!av) { return ak([]) } if (this.form.length) { ax = ak(this.form[0].elements).filter(aw) } else { ax = ak(aw).filter(function() { return ak(this).form().length === 0 }) } return ax.not(this.element) },
        _toggleClasses: function() {
            ...
            if (this.type === "radio") { this._getRadioGroup().each(function() { var aw = ak(this).checkboxradio("instance"); if (aw) { aw._removeClass(aw.label, "ui-checkboxradio-checked", "ui-state-active") } }) }
        },
        _destroy: function() {
    ...
    ak.widget("ui.button", {
        ...
        options: { classes: { "ui-button": "ui-corner-all" }, disabled: null, icon: null, iconPosition: "beginning", label: null, showLabel: true },
        _getCreateOptions: function() {
        ...
        _create: function() {
            ...
            if (this.options.label && this.options.label !== this.originalLabel) { if (this.isInput) { this.element.val(this.options.label) } else { this.element.html(this.options.label) } }
            this._addClass("ui-button", "ui-widget");
            this._setOption("disabled", this.options.disabled);
            this._enhance();
            if (this.element.is("a")) { this._on({ keyup: function(av) { if (av.keyCode === ak.ui.keyCode.SPACE) { av.preventDefault(); if (this.element[0].click) { this.element[0].click() } else { this.element.trigger("click") } } } }) }
        },
        _enhance: function() {
        ...
        _updateTooltip: function() { this.title = this.element.attr("title"); if (!this.options.showLabel && !this.title) { this.element.attr("title", this.options.label) } },
        _updateIcon: function(ax, az) {
            ...
            this._attachIcon(av);
            if (ay) { this._addClass(this.icon, null, "ui-widget-icon-block"); if (this.iconSpace) { this.iconSpace.remove() } } else {
                if (!this.iconSpace) {
                    this.iconSpace = ak("<span> </span>");
        ...
        _destroy: function() { this.element.removeAttr("role"); if (this.icon) { this.icon.remove() } if (this.iconSpace) { this.iconSpace.remove() } if (!this.hasTitle) { this.element.removeAttr("title") } },
        ...
        _setOption: function(av, aw) {
            if (av === "icon") { if (aw) { this._updateIcon(av, aw) } else { if (this.icon) { this.icon.remove(); if (this.iconSpace) { this.iconSpace.remove() } } } }
            ...
            if (av === "label") {
                if (this.isInput) { this.element.val(aw) } else {
    ...
    if (ak.uiBackCompat !== false) {
        ak.widget("ui.button", ak.ui.button, {
            ...
            _create: function() {
                ...
                if (!this.options.icon && (this.options.icons.primary || this.options.icons.secondary)) {
                    if (this.options.icons.primary) { this.options.icon = this.options.icons.primary } else {
            ...
            _setOption: function(av, aw) {
                if (av === "text") { this._super("showLabel", aw); return }
        ...
        ak.fn.button = (function(av) { return function() { if (!this.length || (this.length && this[0].tagName !== "INPUT") || (this.length && this[0].tagName === "INPUT" && (this.attr("type") !== "checkbox" && this.attr("type") !== "radio"))) { return av.Apply(this, arguments) } if (!ak.ui.checkboxradio) { ak.error("Checkboxradio widget missing") } if (arguments.length === 0) { return this.checkboxradio({ icon: false }) } return this.checkboxradio.Apply(this, arguments) } })(ak.fn.button);
        ak.fn.buttonset = function() { if (!ak.ui.controlgroup) { ak.error("Controlgroup widget missing") } if (arguments[0] === "option" && arguments[1] === "items" && arguments[2]) { return this.controlgroup.Apply(this, [arguments[0], "items.button", arguments[2]]) } if (arguments[0] === "option" && arguments[1] === "items") { return this.controlgroup.Apply(this, [arguments[0], "items.button"]) } if (typeof arguments[0] === "object" && arguments[0].items) { arguments[0].items = { button: arguments[0].items } } return this.controlgroup.Apply(this, arguments) }
    }
    var C = ak.ui.button;
    /*!
    ...
    function af(aw) {
        ...
        while (aw.length && aw[0] !== document) {
            av = aw.css("position");
            if (av === "absolute" || av === "relative" || av === "fixed") { ax = parseInt(aw.css("zIndex"), 10); if (!isNaN(ax) && ax !== 0) { return ax } }
            aw = aw.parent()
        }
        return 0
    }
    ...
    ak.extend(P.prototype, {
        ...
        setDefaults: function(av) { F(this._defaults, av || {}); return this },
        _attachDatepicker: function(ay, av) {
            ...
            if (az === "input") { this._connectDatepicker(ay, aw) } else { if (ax) { this._inlineDatepicker(ay, aw) } }
        },
        _newInst: function(aw, av) { var ax = aw[0].id.replace(/([^A-Za-z0-9_\-])/g, "\\\\$1"); return { id: ax, input: aw, selectedDay: 0, selectedMonth: 0, selectedYear: 0, drawMonth: 0, drawYear: 0, inline: av, dpDiv: (!av ? this.dpDiv : X(ak("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))) } },
        ...
        _attachments: function(ax, aA) {
            ...
            if (aw === "button" || aw === "both") {
                ...
                aA.trigger.on("click", function() {
                    if (ak.datepicker._datepickerShowing && ak.datepicker._lastInput === ax[0]) { ak.datepicker._hideDatepicker() } else {
        ...
        _enableDatepicker: function(ay) {
            ...
            if (az === "input") {
                ay.disabled = false;
                aw.trigger.filter("button").each(function() { this.disabled = false }).end().filter("img").css({ opacity: "1.0", cursor: "" })
            } else {
                if (az === "div" || az === "span") {
        ...
        _disableDatepicker: function(ay) {
            ...
            if (az === "input") {
                ay.disabled = true;
                aw.trigger.filter("button").each(function() { this.disabled = true }).end().filter("img").css({ opacity: "0.5", cursor: "default" })
            } else {
                if (az === "div" || az === "span") {
                    ax = av.children("." + this._inlineClass);
        ...
        _isDisabledDatepicker: function(aw) { if (!aw) { return false } for (var av = 0; av < this._disabledInputs.length; av++) { if (this._disabledInputs[av] === aw) { return true } } return false },
        _getInst: function(aw) { try { return ak.data(aw, "datepicker") } catch (av) { throw "Missing instance data for this datepicker" } },
        _optionDatepicker: function(aB, aw, aA) {
            ...
            if (ay) {
                if (this._curInst === ay) { this._hideDatepicker() }
                ...
                if ("disabled" in ax) { if (ax.disabled) { this._disableDatepicker(aB) } else { this._enableDatepicker(aB) } }
        ...
        _refreshDatepicker: function(aw) { var av = this._getInst(aw); if (av) { this._updateDatepicker(av) } },
        ...
        _getDateDatepicker: function(ax, av) { var aw = this._getInst(ax); if (aw && !aw.inline) { this._setDateFromField(aw, av) } return (aw ? this._getDate(aw) : null) },
        _doKeyDown: function(ay) {
            ...
            if (ak.datepicker._datepickerShowing) {
                switch (ay.keyCode) {
                    ...
                    case 34:
                        ...
                        break;
                    case 35:
                        if (ay.ctrlKey || ay.metaKey) { ak.datepicker._clearDate(ay.target) }
                        aB = ay.ctrlKey || ay.metaKey;
                        break;
                    case 36:
                        if (ay.ctrlKey || ay.metaKey) { ak.datepicker._gotoToday(ay.target) }
                        aB = ay.ctrlKey || ay.metaKey;
                        break;
                    case 37:
                        if (ay.ctrlKey || ay.metaKey) { ak.datepicker._adjustDate(ay.target, (ax ? +1 : -1), "D") }
                        aB = ay.ctrlKey || ay.metaKey;
                        ...
                        break;
                    case 38:
                        if (ay.ctrlKey || ay.metaKey) { ak.datepicker._adjustDate(ay.target, -7, "D") }
                        aB = ay.ctrlKey || ay.metaKey;
                        break;
                    case 39:
                        if (ay.ctrlKey || ay.metaKey) { ak.datepicker._adjustDate(ay.target, (ax ? -1 : +1), "D") }
            ...
            } else { if (ay.keyCode === 36 && ay.ctrlKey) { ak.datepicker._showDatepicker(this) } else { aB = false } }
            if (aB) {
                ay.preventDefault();
                ay.stopPropagation()
            }
        ...
        _showDatepicker: function(aw) {
            ...
            if (ak.datepicker._curInst && ak.datepicker._curInst !== ay) { ak.datepicker._curInst.dpDiv.stop(true, true); if (ay && ak.datepicker._datepickerShowing) { ak.datepicker._hideDatepicker(ak.datepicker._curInst.input[0]) } }
            ...
            aA = false;
            ak(aw).parents().each(function() { aA |= ak(this).css("position") === "fixed"; return !aA });
            ...
            if (!ay.inline) {
                ...
                if (ak.effects && ak.effects.effect[av]) { ay.dpDiv.show(av, ak.datepicker._get(ay, "showOptions"), az) } else { ay.dpDiv[av || "show"](av ? az : null) }
        ...
        _updateDatepicker: function(ay) {
            ...
            if (ay.yearshtml) {
                aA = ay.yearshtml;
                setTimeout(function() {
                    if (aA === ay.yearshtml && ay.yearshtml) { ay.dpDiv.find("select.ui-datepicker-year:first").replaceWith(ay.yearshtml) }
        ...
        _hideDatepicker: function(ax) {
            ...
            if (this._datepickerShowing) {
                ...
                if (ak.effects && (ak.effects.effect[aw] || ak.effects[aw])) { ay.dpDiv.hide(aw, ak.datepicker._get(ay, "showOptions"), aA, az) } else { ay.dpDiv[(aw === "slideDown" ? "slideUp" : (aw === "fadeIn" ? "fadeOut" : "hide"))]((aw ? aA : null), az) }
                if (!aw) { az() }
                this._datepickerShowing = false;
        ...
        _checkExternalClick: function(aw) {
            if (!ak.datepicker._curInst) { return }
            var av = ak(aw.target),
        ...
        _selectDate: function(az, av) {
            ...
            if (aw) { aw.Apply((ax.input ? ax.input[0] : null), [av, ax]) } else { if (ax.input) { ax.input.trigger("change") } }
            if (ax.inline) { this._updateDatepicker(ax) } else {
        ...
        noWeekends: function(aw) { var av = aw.getDay(); return [(av > 0 && av < 6), ""] },
        ...
        parseDate: function(aL, aG, aN) {
            if (aL == null || aG == null) { throw "Invalid arguments" }
            ...
            var ay, aI, aw, aM = 0,
                ...
                aD = -1,
                aJ = false,
                aO, aF = function(aS) { var aT = (ay + 1 < aL.length && aL.charAt(ay + 1) === aS); if (aT) { ay++ } return aT },
                aR = function(aU) {
                    var aS = aF(aU),
                ...
                aC = function(aT, aU, aW) {
                    ...
                    if (aS !== -1) { return aS + 1 } else { throw "Unknown name at position " + aM }
                },
                aH = function() {
                    if (aG.charAt(aM) !== aL.charAt(ay)) { throw "Unexpected literal at position " + aM }
                    aM++
                };
            for (ay = 0; ay < aL.length; ay++) {
                if (aJ) { if (aL.charAt(ay) === "'" && !aF("'")) { aJ = false } else { aH() } } else {
                    switch (aL.charAt(ay)) {
                        case "d":
                            aK = aR("d");
                            break;
            ...
            if (aM < aG.length) { aw = aG.substr(aM); if (!/^\s+/.test(aw)) { throw "Extra/unparsed characters found in date: " + aw } }
        ...
        formatDate: function(aE, ay, az) {
            ...
            var aG, aH = (az ? az.dayNamesShort : null) || this._defaults.dayNamesShort,
                ...
                aF = function(aI) { var aJ = (aG + 1 < aE.length && aE.charAt(aG + 1) === aI); if (aJ) { aG++ } return aJ },
                av = function(aK, aL, aI) { var aJ = "" + aL; if (aF(aK)) { while (aJ.length < aI) { aJ = "0" + aJ } } return aJ },
                aB = function(aI, aK, aJ, aL) { return (aF(aI) ? aL[aK] : aJ[aK]) },
                ax = "",
                aD = false;
            if (ay) {
                for (aG = 0; aG < aE.length; aG++) {
                    if (aD) { if (aE.charAt(aG) === "'" && !aF("'")) { aD = false } else { ax += aE.charAt(aG) } } else {
                        switch (aE.charAt(aG)) {
                            case "d":
        ...
        _possibleChars: function(az) {
            var ay, ax = "",
                aw = false,
                av = function(aA) { var aB = (ay + 1 < az.length && az.charAt(ay + 1) === aA); if (aB) { ay++ } return aB };
            for (ay = 0; ay < az.length; ay++) {
                if (aw) { if (az.charAt(ay) === "'" && !av("'")) { aw = false } else { ax += az.charAt(ay) } } else {
                    switch (az.charAt(ay)) {
                        case "d":
                        case "m":
                        case "y":
        ...
        _setDateFromField: function(aA, ax) {
            if (aA.input.val() === aA.lastVal) { return }
        ...
        _determineDate: function(az, aw, aA) {
            var ay = function(aC) {
                ...
                ax = function(aI) {
                    try { return ak.datepicker.parseDate(ak.datepicker._get(az, "dateFormat"), aI, ak.datepicker._getFormatConfig(az)) } catch (aH) {}
        ...
        _getDate: function(aw) { var av = (!aw.currentYear || (aw.input && aw.input.val() === "") ? null : this._daylightSavingAdjust(new Date(aw.currentYear, aw.currentMonth, aw.currentDay))); return av },
        _attachHandlers: function(aw) {
            var av = this._get(aw, "stepMonths"),
                ax = "#" + aw.id.replace(/\\\\/g, "\\");
            aw.dpDiv.find("[data-handler]").map(function() {
                var ay = { prev: function() { ak.datepicker._adjustDate(ax, -av, "M") }, next: function() { ak.datepicker._adjustDate(ax, +av, "M") }, hide: function() { ak.datepicker._hideDatepicker() }, today: function() { ak.datepicker._gotoToday(ax) }, selectDay: function() { ak.datepicker._selectDay(ax, +this.getAttribute("data-month"), +this.getAttribute("data-year"), this); return false }, selectMonth: function() { ak.datepicker._selectMonthYear(ax, this, "M"); return false }, selectYear: function() { ak.datepicker._selectMonthYear(ax, this, "Y"); return false } };
        ...
        _generateMonthYearHeader: function(az, ax, aH, aB, aF, aI, aD, av) {
            var aM, aw, aN, aK, aA, aJ, aG, aC, ay = this._get(az, "changeMonth"),
                ...
                aL = "";
            if (aI || !ay) { aL += "<span class='ui-datepicker-month'>" + aD[ax] + "</span>" } else {
            ...
            if (!az.yearshtml) {
                az.yearshtml = "";
                if (aI || !aO) { aE += "<span class='ui-datepicker-year'>" + aH + "</span>" } else {
                    aK = this._get(az, "yearRange").split(":");
                    aA = new Date().getFullYear();
                    aJ = function(aR) { var aQ = (aR.match(/c[+\-].*/) ? aH + parseInt(aR.substring(1), 10) : (aR.match(/[+\-].*/) ? aA + parseInt(aR, 10) : parseInt(aR, 10))); return (isNaN(aQ) ? aA : aQ) };
                    aG = aJ(aK[0]);
        ...
        _notifyChange: function(aw) { var av = this._get(aw, "onChangeMonthYear"); if (av) { av.Apply((aw.input ? aw.input[0] : null), [aw.selectedYear, aw.selectedMonth + 1, aw]) } },
        _getNumberOfMonths: function(aw) { var av = this._get(aw, "numberOfMonths"); return (av == null ? [1, 1] : (typeof av === "number" ? [1, av] : av)) },
    ...
    function X(aw) { var av = "button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a"; return aw.on("mouseout", av, function() { ak(this).removeClass("ui-state-hover"); if (this.className.indexOf("ui-datepicker-prev") !== -1) { ak(this).removeClass("ui-datepicker-prev-hover") } if (this.className.indexOf("ui-datepicker-next") !== -1) { ak(this).removeClass("ui-datepicker-next-hover") } }).on("mouseover", av, K) }
    ...
    function F(ax, aw) { ak.extend(ax, aw); for (var av in aw) { if (aw[av] == null) { ax[av] = aw[av] } } return ax }
    ...
    var a = ak.widget("ui.mouse", {
        ...
        _mouseInit: function() {
            var av = this;
            this.element.on("mousedown." + this.widgetName, function(aw) { return av._mouseDown(aw) }).on("click." + this.widgetName, function(aw) {
        ...
        _mouseDown: function(ax) {
            ...
            if (!this.mouseDelayMet) { this._mouseDelayTimer = setTimeout(function() { aw.mouseDelayMet = true }, this.options.delay) }
            if (this._mouseDistanceMet(ax) && this._mouseDelayMet(ax)) { this._mouseStarted = (this._mouseStart(ax) !== false); if (!this._mouseStarted) { ax.preventDefault(); return true } }
        ...
        _mouseMove: function(av) {
            if (this._mouseMoved) { if (ak.ui.ie && (!document.documentMode || document.documentMode < 9) && !av.button) { return this._mouseUp(av) } else { if (!av.which) { if (av.originalEvent.altKey || av.originalEvent.ctrlKey || av.originalEvent.metaKey || av.originalEvent.shiftKey) { this.ignoreMissingWhich = true } else { if (!this.ignoreMissingWhich) { return this._mouseUp(av) } } } } }
    ...
    var G = ak.ui.plugin = {
        ...
        call: function(av, ay, ax, aw) { var az, aA = av.plugins[ay]; if (!aA) { return } if (!aw && (!av.element[0].parentNode || av.element[0].parentNode.nodeType === 11)) { return } for (az = 0; az < aA.length; az++) { if (av.options[aA[az][0]]) { aA[az][1].Apply(av.element, ax) } } }
    };
    ...
    ak.widget("ui.draggable", ak.ui.mouse, {
        ...
        _blockFrames: function(av) { this.iframeBlocks = this.document.find(av).map(function() { var aw = ak(this); return ak("<div>").css("position", "absolute").appendTo(aw.parent()).outerWidth(aw.outerWidth()).outerHeight(aw.outerHeight()).offset(aw.offset())[0] }) },
        ...
        _mouseStart: function(av) {
            ...
            this.hasFixedAncestor = this.helper.parents().filter(function() { return ak(this).css("position") === "fixed" }).length > 0;
            ...
            if (this._trigger("start", av) === false) { this._clear(); return false }
            this._cacheHelperProportions();
        ...
        _mouseDrag: function(av, ax) {
            ...
            if (!ax) {
                var aw = this._uiHash();
                if (this._trigger("drag", av, aw) === false) { this._mouseUp(new ak.Event("mouseup", av)); return false }
        ...
        _mouseStop: function(aw) {
            ...
            if ((this.options.revert === "invalid" && !ax) || (this.options.revert === "valid" && ax) || this.options.revert === true || (ak.isFunction(this.options.revert) && this.options.revert.call(this.element, ax))) { ak(this.helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10), function() { if (av._trigger("stop", aw) !== false) { av._clear() } }) } else { if (this._trigger("stop", aw) !== false) { this._clear() } }
            return false
        },
        _mouseUp: function(av) { this._unblockFrames(); if (ak.ui.ddmanager) { ak.ui.ddmanager.dragStop(this, av) } if (this.handleElement.is(av.target)) { this.element.trigger("focus") } return ak.ui.mouse.prototype._mouseUp.call(this, av) },
        cancel: function() { if (this.helper.is(".ui-draggable-dragging")) { this._mouseUp(new ak.Event("mouseup", { target: this.element[0] })) } else { this._clear() } return this },
        ...
        _adjustOffsetFromHelper: function(av) { if (typeof av === "string") { av = av.split(" ") } if (ak.isArray(av)) { av = { left: +av[0], top: +av[1] || 0 } } if ("left" in av) { this.offset.click.left = av.left + this.margins.left } if ("right" in av) { this.offset.click.left = this.helperProportions.width - av.right + this.margins.left } if ("top" in av) { this.offset.click.top = av.top + this.margins.top } if ("bottom" in av) { this.offset.click.top = this.helperProportions.height - av.bottom + this.margins.top } },
        ...
        _setContainment: function() {
            ...
            if (!ay.containment) { this.containment = null; return }
            if (ay.containment === "window") { this.containment = [ak(window).scrollLeft() - this.offset.relative.left - this.offset.parent.left, ak(window).scrollTop() - this.offset.relative.top - this.offset.parent.top, ak(window).scrollLeft() + ak(window).width() - this.helperProportions.width - this.margins.left, ak(window).scrollTop() + (ak(window).height() || av.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top]; return }
            if (ay.containment === "document") { this.containment = [0, 0, ak(av).width() - this.helperProportions.width - this.margins.left, (ak(av).height() || av.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top]; return }
            if (ay.containment.constructor === Array) { this.containment = ay.containment; return }
    ...
    ak.ui.plugin.add("draggable", "connectToSortable", {
        start: function(ax, ay, av) {
            var aw = ak.extend({}, ay, { item: av.element });
            av.sortables = [];
    ...
    ak.ui.plugin.add("draggable", "opacity", {
        ...
        stop: function(aw, ax, av) { var ay = av.options; if (ay._opacity) { ak(ax.helper).css("opacity", ay._opacity) } }
    });
    ak.ui.plugin.add("draggable", "scroll", {
        start: function(aw, ax, av) { if (!av.scrollParentNotHidden) { av.scrollParentNotHidden = av.helper.scrollParent(false) } if (av.scrollParentNotHidden[0] !== av.document[0] && av.scrollParentNotHidden[0].tagName !== "HTML") { av.overflowOffset = av.scrollParentNotHidden.offset() } },
        drag: function(ay, az, ax) {
            var aA = ax.options,
                aw = false,
                aB = ax.scrollParentNotHidden[0],
                av = ax.document[0];
            if (aB !== av && aB.tagName !== "HTML") { if (!aA.axis || aA.axis !== "x") { if ((ax.overflowOffset.top + aB.offsetHeight) - ay.pageY < aA.scrollSensitivity) { aB.scrollTop = aw = aB.scrollTop + aA.scrollSpeed } else { if (ay.pageY - ax.overflowOffset.top < aA.scrollSensitivity) { aB.scrollTop = aw = aB.scrollTop - aA.scrollSpeed } } } if (!aA.axis || aA.axis !== "y") { if ((ax.overflowOffset.left + aB.offsetWidth) - ay.pageX < aA.scrollSensitivity) { aB.scrollLeft = aw = aB.scrollLeft + aA.scrollSpeed } else { if (ay.pageX - ax.overflowOffset.left < aA.scrollSensitivity) { aB.scrollLeft = aw = aB.scrollLeft - aA.scrollSpeed } } } } else { if (!aA.axis || aA.axis !== "x") { if (ay.pageY - ak(av).scrollTop() < aA.scrollSensitivity) { aw = ak(av).scrollTop(ak(av).scrollTop() - aA.scrollSpeed) } else { if (ak(window).height() - (ay.pageY - ak(av).scrollTop()) < aA.scrollSensitivity) { aw = ak(av).scrollTop(ak(av).scrollTop() + aA.scrollSpeed) } } } if (!aA.axis || aA.axis !== "y") { if (ay.pageX - ak(av).scrollLeft() < aA.scrollSensitivity) { aw = ak(av).scrollLeft(ak(av).scrollLeft() - aA.scrollSpeed) } else { if (ak(window).width() - (ay.pageX - ak(av).scrollLeft()) < aA.scrollSensitivity) { aw = ak(av).scrollLeft(ak(av).scrollLeft() + aA.scrollSpeed) } } } }
            ...
            for (aI = ay.snapElements.length - 1; aI >= 0; aI--) {
                ...
                if (aJ < aG - aL || aK > aD + aL || aw < aC - aL || ax > aN + aL || !ak.contains(ay.snapElements[aI].item.ownerDocument, ay.snapElements[aI].item)) {
                    if (ay.snapElements[aI].snapping) {
                        (ay.options.snap.release && ay.options.snap.release.call(ay.element, aH, ak.extend(ay._uiHash(), { snapItem: ay.snapElements[aI].item })))
                    }
                ...
                if (!ay.snapElements[aI].snapping && (av || aM || aA || aB || az)) {
                    (ay.options.snap.snap && ay.options.snap.snap.call(ay.element, aH, ak.extend(ay._uiHash(), { snapItem: ay.snapElements[aI].item })))
                }
    ...
    ak.ui.plugin.add("draggable", "stack", {
        start: function(ax, ay, av) {
            var aw, aA = av.options,
                az = ak.makeArray(ak(aA.stack)).sort(function(aC, aB) { return (parseInt(ak(aC).css("zIndex"), 10) || 0) - (parseInt(ak(aB).css("zIndex"), 10) || 0) });
            if (!az.length) { return }
    ...
    ak.widget("ui.resizable", ak.ui.mouse, {
        ...
        _num: function(av) { return parseFloat(av) || 0 },
        _isNumber: function(av) { return !isNaN(parseFloat(av)) },
        _hasScroll: function(ay, aw) {
            if (ak(ay).css("overflow") === "hidden") { return false }
        ...
        _create: function() {
            ...
            if (this.element[0].nodeName.match(/^(canvas|textarea|input|select|button|img)$/i)) {
                this.element.wrap(ak("<div class='ui-wrapper' style='overflow: hidden;'></div>").css({ position: this.element.css("position"), width: this.element.outerWidth(), height: this.element.outerHeight(), top: this.element.css("top"), left: this.element.css("left") }));
        ...
        _setupHandles: function() {
            ...
            this._renderAxis = function(aG) {
                ...
                for (aD in this.handles) {
                    if (this.handles[aD].constructor === String) { this.handles[aD] = this.element.children(this.handles[aD]).first().show() } else {
            ...
            this._handles.on("mouseover", function() {
                if (!ay.resizing) {
                    if (this.className) { ax = this.className.match(/ui-resizable-(se|sw|ne|nw|n|e|s|w)/i) }
        ...
        _mouseCapture: function(ax) { var aw, ay, av = false; for (aw in this.handles) { ay = ak(this.handles[aw])[0]; if (ay === ax.target || ak.contains(ay, ax.target)) { av = true } } return !this.options.disabled && av },
        ...
        _updateCache: function(av) { this.offset = this.helper.offset(); if (this._isNumber(av.left)) { this.position.left = av.left } if (this._isNumber(av.top)) { this.position.top = av.top } if (this._isNumber(av.height)) { this.size.height = av.height } if (this._isNumber(av.width)) { this.size.width = av.width } },
        _updateRatio: function(ax) {
            var ay = this.position,
                aw = this.size,
                av = this.axis;
            if (this._isNumber(ax.height)) { ax.width = (ax.height * this.aspectRatio) } else { if (this._isNumber(ax.width)) { ax.height = (ax.width / this.aspectRatio) } }
            if (av === "sw") {
        ...
        _respectSize: function(aA) {
            ...
            if (!aA.width && !aA.height && !aA.left && aA.top) { aA.top = null } else { if (!aA.width && !aA.height && !aA.top && aA.left) { aA.left = null } }
            return aA
        },
        ...
        _change: {
            e: function(aw, av) { return { width: this.originalSize.width + av } },
            w: function(ax, av) {
    ...
    ak.ui.plugin.add("resizable", "animate", {
        stop: function(ay) {
            var aD = ak(this).resizable("instance"),
                ...
                az = { width: (aD.size.width - aC), height: (aD.size.height - aw) },
            ...
            aD.element.animate(ak.extend(az, aE && aB ? { top: aE, left: aB } : {}), {
                duration: aA.animateDuration,
                easing: aA.animateEasing,
                step: function() {
                    var aF = { width: parseFloat(aD.element.css("width")), height: parseFloat(aD.element.css("height")), top: parseFloat(aD.element.css("top")), left: parseFloat(aD.element.css("left")) };
    ...
    ak.ui.plugin.add("resizable", "containment", {
        start: function() {
            ...
            if (/document/.test(aw) || aw === document) {
                aE.containerOffset = { left: 0, top: 0 };
    ...
    ak.ui.plugin.add("resizable", "alsoResize", {
        ...
        resize: function(aw, ay) {
            var av = ak(this).resizable("instance"),
                ...
                aA = { height: (av.size.height - ax.height) || 0, width: (av.size.width - ax.width) || 0, top: (av.position.top - aB.top) || 0, left: (av.position.left - aB.left) || 0 };
            ak(az.alsoResize).each(function() {
                ...
                ak.each(aC, function(aG, aI) { var aH = (aF[aI] || 0) + (aA[aI] || 0); if (aH && aH >= 0) { aD[aI] = aH || null } });
                aE.css(aD)
            })
        },
    ...
    ak.ui.plugin.add("resizable", "ghost", {
        ...
        resize: function() { var av = ak(this).resizable("instance"); if (av.ghost) { av.ghost.css({ position: "relative", height: av.size.height, width: av.size.width }) } },
        stop: function() { var av = ak(this).resizable("instance"); if (av.ghost && av.helper) { av.helper.get(0).removeChild(av.ghost.get(0)) } }
    });
            ...
            if (/^(se|s|e)$/.test(aM)) {
                ...
                if (/^(ne)$/.test(aM)) {
                    ...
                    if (/^(sw)$/.test(aM)) {
                        ...
                        if (aI - aJ <= 0 || aF - aK <= 0) { ay = aD._getPaddingPlusBorderDimensions(this) }
                        if (aI - aJ > 0) {
                            aD.size.height = aI;
                            aD.position.top = aE.top - az
                        } else {
    ...
    ak.widget("ui.dialog", {
        ...
        _appendTo: function() { var av = this.options.appendTo; if (av && (av.jquery || av.nodeType)) { return ak(av) } return this.document.find(av || "body").eq(0) },
        _destroy: function() {
            ...
            if (aw.length && aw[0] !== this.element[0]) { aw.before(this.element) } else { av.parent.append(this.element) }
        },
        ...
        _moveToTop: function(az, av) {
            var ay = false,
                ax = this.uiDialog.siblings(".ui-front:visible").map(function() { return +ak(this).css("z-index") }).get(),
        ...
        open: function() {
            var av = this;
            if (this._isOpen) { if (this._moveToTop()) { this._focusTabbable() } return }
            this._isOpen = true;
        ...
        _createWrapper: function() {
            this.uiDialog = ak("<div>").hide().attr({ tabIndex: -1, role: "dialog" }).appendTo(this._appendTo());
            ...
            this._on(this.uiDialog, {
                keydown: function(ax) {
                    ...
                    if ((ax.target === av[0] || ax.target === this.uiDialog[0]) && !ax.shiftKey) {
                        this._delay(function() { ay.trigger("focus") });
                        ax.preventDefault()
                    } else {
                        if ((ax.target === ay[0] || ax.target === this.uiDialog[0]) && ax.shiftKey) {
                            this._delay(function() { av.trigger("focus") });
                            ax.preventDefault()
                        }
                    }
                },
        ...
        _title: function(av) { if (this.options.title) { av.text(this.options.title) } else { av.html("&#160;") } },
        ...
        _createButtons: function() {
            ...
            if (ak.isEmptyObject(av) || (ak.isArray(av) && !av.length)) { this._removeClass(this.uiDialog, "ui-dialog-buttons"); return }
        ...
        _minHeight: function() { var av = this.options; return av.height === "auto" ? av.minHeight : Math.min(av.minHeight, av.height) },
        _position: function() {
        ...
        _setOptions: function(ax) {
            var ay = this,
                aw = false,
                av = {};
            ak.each(ax, function(az, aA) { ay._setOption(az, aA); if (az in ay.sizeRelatedOptions) { aw = true } if (az in ay.resizableRelatedOptions) { av[az] = aA } });
            if (aw) {
                this._size();
                this._position()
            }
        ...
        _setOption: function(ax, ay) {
            ...
            if (ax === "draggable") { aw = av.is(":data(ui-draggable)"); if (aw && !ay) { av.draggable("destroy") } if (!aw && ay) { this._makeDraggable() } }
            if (ax === "position") { this._position() }
            if (ax === "resizable") { az = av.is(":data(ui-resizable)"); if (az && !ay) { av.resizable("destroy") } if (az && typeof ay === "string") { av.resizable("option", "handles", ay) } if (!az && ay !== false) { this._makeResizable() } }
        ...
        _size: function() {
            ...
            if (aw.height === "auto") { this.element.css({ minHeight: ax, maxHeight: ay, height: "auto" }) } else { this.element.height(Math.max(0, aw.height - av)) }
            if (this.uiDialog.is(":data(ui-resizable)")) { this.uiDialog.resizable("option", "minHeight", this._minHeight()) }
        },
        _blockFrames: function() { this.iframeBlocks = this.document.find("iframe").map(function() { var av = ak(this); return ak("<div>").css({ position: "absolute", width: av.outerWidth(), height: av.outerHeight() }).appendTo(av.parent()).offset(av.offset())[0] }) },
        _unblockFrames: function() {
            if (this.iframeBlocks) {
                this.iframeBlocks.remove();
                delete this.iframeBlocks
        ...
        _allowInteraction: function(av) { if (ak(av.target).closest(".ui-dialog").length) { return true } return !!ak(av.target).closest(".ui-datepicker").length },
    ...
    if (ak.uiBackCompat !== false) {
        ak.widget("ui.dialog", ak.ui.dialog, {
            ...
            _setOption: function(av, aw) {
                if (av === "dialogClass") { this.uiDialog.removeClass(this.options.dialogClass).addClass(aw) }
                this._superApply(arguments)
            }
        })
    }
    ...
    ak.widget("ui.droppable", {
        ...
        _create: function() {
            ...
            this.proportions = function() { if (arguments.length) { aw = arguments[0] } else { return aw ? aw : aw = { width: this.element[0].offsetWidth, height: this.element[0].offsetHeight } } };
        ...
        _splice: function(av) { var aw = 0; for (; aw < av.length; aw++) { if (av[aw] === this) { av.splice(aw, 1) } } },
        _destroy: function() {
            var av = ak.ui.ddmanager.droppables[this.options.scope];
            this._splice(av)
        },
        _setOption: function(aw, ax) {
            if (aw === "accept") { this.accept = ak.isFunction(ax) ? ax : function(ay) { return ay.is(ax) } } else {
                if (aw === "scope") {
                    var av = ak.ui.ddmanager.droppables[this.options.scope];
                    this._splice(av);
    ...
    var s = ak.ui.intersect = (function() {
        function av(ax, aw, ay) { return (ax >= aw) && (ax < (aw + ay)) }
        return function(aH, aB, aF, ax) {
            if (!aB.offset) { return false }
    ...
    ak.ui.ddmanager = {
        ...
        prepareOffsets: function(ay, aA) {
            ...
            droppablesLoop: for (ax = 0; ax < av.length; ax++) {
                if (av[ax].options.disabled || (ay && !av[ax].accept.call(av[ax].element[0], (ay.currentItem || ay.element)))) { continue }
                for (aw = 0; aw < aB.length; aw++) { if (aB[aw] === av[ax].element[0]) { av[ax].proportions().height = 0; continue droppablesLoop } }
        ...
        dragStop: function(av, aw) { av.element.parentsUntil("body").off("scroll.droppable"); if (!av.options.refreshPositions) { ak.ui.ddmanager.prepareOffsets(av, aw) } }
    };
    ...
    var Y = ak.widget("ui.progressbar", {
        ...
        value: function(av) {
            if (av === undefined) { return this.options.value }
            this.options.value = this._constrainedValue(av);
            this._refreshValue()
        },
        _constrainedValue: function(av) {
            if (av === undefined) { av = this.options.value }
        ...
        _setOption: function(av, aw) {
            if (av === "max") { aw = Math.max(this.min, aw) }
            this._super(av, aw)
        },
        _setOptionDisabled: function(av) {
            this._super(av);
        ...
        _refreshValue: function() {
            ...
            if (this.indeterminate) {
                ...
                this.element.attr({ "aria-valuemax": this.options.max, "aria-valuenow": aw });
                if (this.overlayDiv) {
        ...
        _create: function() {
            ...
            this.refresh = function() {
                ...
                av.selectees.each(function() {
                    var ax = ak(this),
                        aw = ax.offset(),
                        ay = { left: aw.left - av.elementPos.left, top: aw.top - av.elementPos.top };
        ...
        _mouseStart: function(ax) {
            ...
            ak(ax.target).parents().addBack().each(function() {
                ...
                if (az) {
                    ...
                    az.selecting = ay;
                    az.selected = ay;
                    if (ay) { aw._trigger("selecting", ax, { selecting: az.element }) } else { aw._trigger("unselecting", ax, { unselecting: az.element }) }
                    return false
                }
            })
        },
    ...
    var e = ak.widget("ui.selectmenu", [ak.ui.formResetMixin, {
        ...
        options: { appendTo: null, classes: { "ui-selectmenu-button-open": "ui-corner-top", "ui-selectmenu-button-closed": "ui-corner-all" }, disabled: null, icons: { button: "ui-icon-triangle-1-s" }, position: { my: "left top", at: "left bottom", collision: "none" }, width: false, change: null, close: null, focus: null, open: null, select: null },
        _create: function() {
        ...
        _drawMenu: function() {
            ...
            this.menuInstance = this.menu.menu({
                ...
                focus: function(ax, ay) {
                    ...
                    if (av.focusIndex != null && aw.index !== av.focusIndex) { av._trigger("focus", ax, { item: aw }); if (!av.isOpen) { av._select(aw, ax) } }
        ...
        _renderItem: function(aw, ax) {
            var av = ak("<li>"),
                ay = ak("<div>", { title: ax.element.attr("title") });
        ...
        _move: function(az, ay) {
            ...
            if (this.isOpen) { ax = this.menuItems.eq(this.focusIndex).parent("li") } else {
                ax = this.menuItems.eq(this.element[0].selectedIndex).parent("li");
                av += ":not(.ui-state-disabled)"
            }
            if (az === "first" || az === "last") { aw = ax[az === "first" ? "prevAll" : "nextAll"](av).eq(-1) } else { aw = ax[az + "All"](av).eq(0) }
        ...
        _documentClick: { mousedown: function(av) { if (!this.isOpen) { return } if (!ak(av.target).closest(".ui-selectmenu-menu, #" + ak.ui.escapeSelector(this.ids.button)).length) { this.close(av) } } },
        _buttonEvents: {
            mousedown: function() { var av; if (window.getSelection) { av = window.getSelection(); if (av.rangeCount) { this.range = av.getRangeAt(0) } } else { this.range = document.selection.createRange() } },
            click: function(av) {
                this._setSelection();
                this._toggle(av)
            },
            keydown: function(aw) {
                ...
                switch (aw.keyCode) {
                    ...
                    case ak.ui.keyCode.ESCAPE:
                        ...
                        break;
                    case ak.ui.keyCode.ENTER:
                        if (this.isOpen) { this._selectFocusedItem(aw) }
                        break;
                    case ak.ui.keyCode.UP:
                        if (aw.altKey) { this._toggle(aw) } else { this._move("prev", aw) }
                        break;
                    case ak.ui.keyCode.DOWN:
                        if (aw.altKey) { this._toggle(aw) } else { this._move("next", aw) }
                        break;
                    case ak.ui.keyCode.SPACE:
                        if (this.isOpen) { this._selectFocusedItem(aw) } else { this._toggle(aw) }
                        break;
                    case ak.ui.keyCode.LEFT:
                        this._move("prev", aw);
                        break;
        ...
        _selectFocusedItem: function(aw) { var av = this.menuItems.eq(this.focusIndex).parent("li"); if (!av.hasClass("ui-state-disabled")) { this._select(av.data("ui-selectmenu-item"), aw) } },
        ...
        _parseOption: function(ax, aw) { var av = ax.parent("optgroup"); return { element: ax, index: aw, value: ax.val(), label: ax.text(), optgroup: av.attr("label") || "", disabled: av.prop("disabled") || ax.prop("disabled") } },
        _destroy: function() {
            this._unbindFormResetHandler();
    ...
    var Q = ak.widget("ui.slider", ak.ui.mouse, {
        ...
        options: { animate: false, classes: { "ui-slider": "ui-corner-all", "ui-slider-handle": "ui-corner-all", "ui-slider-range": "ui-corner-all ui-widget-header" }, distance: 0, max: 100, min: 0, orientation: "horizontal", range: false, step: 1, value: 0, values: null, change: null, slide: null, start: null, stop: null },
        numPages: 5,
        _create: function() {
        ...
        _createHandles: function() {
            ...
            for (ay = aA.length; ay < av; ay++) { ax.push(az) }
        ...
        _createRange: function() {
            var av = this.options;
            if (av.range) {
                if (av.range === true) { if (!av.values) { av.values = [this._valueMin(), this._valueMin()] } else { if (av.values.length && av.values.length !== 2) { av.values = [av.values[0], av.values[0]] } else { if (ak.isArray(av.values)) { av.values = av.values.slice(0) } } } }
        ...
        _uiHash: function(ax, ay, av) {
            var aw = { handle: this.handles[ax], handleIndex: ax, value: ay !== undefined ? ay : this.value() };
        ...
        _slide: function(aA, ay, ax) {
            ...
            if (aB === false) { return }
            if (this._hasMultipleValues()) { this.values(ay, ax) } else { this.value(ax) }
        },
        ...
        values: function(aw, az) {
            ...
            if (arguments.length) {
                if (ak.isArray(arguments[0])) {
                    ...
                    this._refreshValue()
                } else { if (this._hasMultipleValues()) { return this._values(aw) } else { return this.value() } }
        ...
        _setOption: function(aw, ax) {
            ...
            switch (aw) {
                ...
                case "values":
                    this._animateOff = true;
                    this._refreshValue();
                    for (av = ay - 1; av >= 0; av--) { this._change(null, av) }
                    this._animateOff = false;
                    break;
                case "step":
                case "min":
        ...
        _values: function(av) {
            ...
            if (arguments.length) {
                ...
                return ay
            } else { if (this._hasMultipleValues()) { ax = this.options.values.slice(); for (aw = 0; aw < ax.length; aw += 1) { ax[aw] = this._trimAlignValue(ax[aw]) } return ax } else { return [] } }
        },
        _trimAlignValue: function(ay) {
            if (ay <= this._valueMin()) { return this._valueMin() }
        ...
        _precision: function() { var av = this._precisionOf(this.options.step); if (this.options.min !== null) { av = Math.max(av, this._precisionOf(this.options.min)) } return av },
        ...
        _refreshRange: function(av) { if (av === "vertical") { this.range.css({ width: "", left: "" }) } if (av === "horizontal") { this.range.css({ height: "", bottom: "" }) } },
        _refreshValue: function() {
        ...
        _handleEvents: {
            keydown: function(az) {
                ...
                if (this._hasMultipleValues()) { ax = aw = this.values(av) } else { ax = aw = this.value() }
                switch (az.keyCode) {
                    case ak.ui.keyCode.HOME:
                        aw = this._valueMin();
                        break;
                    ...
                    case ak.ui.keyCode.UP:
                    case ak.ui.keyCode.RIGHT:
                        if (ax === this._valueMax()) { return }
                        aw = this._trimAlignValue(ax + ay);
                        break;
                    case ak.ui.keyCode.DOWN:
                    case ak.ui.keyCode.LEFT:
                        if (ax === this._valueMin()) { return }
                        aw = this._trimAlignValue(ax - ay);
                        break
                }
    ...
    var T = ak.widget("ui.sortable", ak.ui.mouse, {
        ...
        _isOverAxis: function(aw, av, ax) { return (aw >= av) && (aw < (av + ax)) },
        ...
        _destroy: function() { this._mouseDestroy(); for (var av = this.items.length - 1; av >= 0; av--) { this.items[av].item.removeData(this.widgetName + "-item") } return this },
        _mouseCapture: function(ax, ay) {
            ...
            ak(ax.target).parents().each(function() { if (ak.data(this, aw.widgetName + "-item") === aw) { av = ak(this); return false } });
            if (ak.data(ax.target, aw.widgetName + "-item") === aw) { av = ak(ax.target) }
            if (!av) { return false }
            if (this.options.handle && !ay) { ak(this.options.handle, av).find("*").addBack().each(function() { if (this === ax.target) { az = true } }); if (!az) { return false } }
            this.currentItem = av;
        ...
        _mouseDrag: function(az) {
            ...
            for (ax = this.items.length - 1; ax >= 0; ax--) {
                ...
                if (aw !== this.currentItem[0] && this.placeholder[aB === 1 ? "next" : "prev"]()[0] !== aw && !ak.contains(this.placeholder[0], aw) && (this.options.type === "semi-dynamic" ? !ak.contains(this.element[0], aw) : true)) {
                    ...
                    if (this.options.tolerance === "pointer" || this._intersectsWithSides(ay)) { this._rearrange(az, ay) } else { break }
        ...
        cancel: function() {
            if (this.dragging) {
                this._mouseUp(new ak.Event("mouseup", { target: null }));
            ...
            if (this.placeholder) {
                ...
                if (this.domPosition.prev) { ak(this.domPosition.prev).after(this.currentItem) } else { ak(this.domPosition.parent).prepend(this.currentItem) }
            }
            return this
        },
        serialize: function(ax) {
            var av = this._getItemsAsjQuery(ax && ax.connected),
                aw = [];
            ax = ax || {};
            ak(av).each(function() { var ay = (ak(ax.item || this).attr(ax.attribute || "id") || "").match(ax.expression || (/(.+)[\-=_](.+)/)); if (ay) { aw.push((ax.key || ay[1] + "[]") + "=" + (ax.key && ax.expression ? ay[1] : ay[2])) } });
        ...
        _intersectsWithSides: function(ay) {
            ...
            if (this.floating && az) { return ((az === "right" && ax) || (az === "left" && !ax)) } else { return av && ((av === "down" && aw) || (av === "up" && !aw)) }
        },
        _getDragVerticalDirection: function() { var av = this.positionAbs.top - this.lastPositionAbs.top; return av !== 0 && (av > 0 ? "down" : "up") },
        _getDragHorizontalDirection: function() { var av = this.positionAbs.left - this.lastPositionAbs.left; return av !== 0 && (av > 0 ? "right" : "left") },
        refresh: function(av) {
        ...
        _connectWith: function() { var av = this.options; return av.connectWith.constructor === String ? [av.connectWith] : av.connectWith },
        _getItemsAsjQuery: function(av) {
            ...
            for (ax = ay.length - 1; ax >= 0; ax--) { ay[ax][0].each(aD) }
            return ak(aA)
        },
        _removeCurrentsFromItems: function() {
            var av = this.currentItem.find(":data(" + this.widgetName + "-item)");
            this.items = ak.grep(this.items, function(ax) { for (var aw = 0; aw < av.length; aw++) { if (av[aw] === ax.item[0]) { return false } } return true })
        },
        _refreshItems: function(av) {
            ...
            var az, ax, aE, aA, aD, aw, aG, aF, aB = this.items,
                ay = [
                    [ak.isFunction(this.options.items) ? this.options.items.call(this.element[0], av, { item: this.currentItem }) : ak(this.options.items, this.element), this]
                ],
                ...
                for (az = aC.length - 1; az >= 0; az--) {
                    ...
                    for (ax = aE.length - 1; ax >= 0; ax--) {
                        ...
                        if (aA && aA !== this && !aA.options.disabled) {
                            ay.push([ak.isFunction(aA.options.items) ? aA.options.items.call(aA.element[0], av, { item: this.currentItem }) : ak(aA.options.items, aA.element), aA]);
            ...
            if (!ax.placeholder || ax.placeholder.constructor === String) {
                ...
                ax.placeholder = {
                    element: function() {
                        ...
                        if (az === "tbody") { aw._createTrPlaceholder(aw.currentItem.find("tr").eq(0), ak("<tr>", aw.document[0]).appendTo(ay)) } else { if (az === "tr") { aw._createTrPlaceholder(aw.currentItem, ay) } else { if (az === "img") { ay.attr("src", aw.currentItem.attr("src")) } } }
                        if (!av) { ay.css("visibility", "hidden") }
                        return ay
                    },
                    update: function(ay, az) { if (av && !ax.forcePlaceholderSize) { return } if (!az.height()) { az.height(aw.currentItem.innerHeight() - parseInt(aw.currentItem.css("paddingTop") || 0, 10) - parseInt(aw.currentItem.css("paddingBottom") || 0, 10)) } if (!az.width()) { az.width(aw.currentItem.innerWidth() - parseInt(aw.currentItem.css("paddingLeft") || 0, 10) - parseInt(aw.currentItem.css("paddingRight") || 0, 10)) } }
                }
            }
        ...
        _contactContainers: function(av) {
            ...
            for (aA = this.containers.length - 1; aA >= 0; aA--) {
                if (ak.contains(this.currentItem[0], this.containers[aA].element[0])) { continue }
                if (this._intersectsWith(this.containers[aA].containerCache)) {
                    if (aw && ak.contains(this.containers[aA].element[0], aw.element[0])) { continue }
            ...
            if (this.containers.length === 1) {
                ...
                for (ay = this.items.length - 1; ay >= 0; ay--) {
                    if (!ak.contains(this.containers[aF].element[0], this.items[ay].item[0])) { continue }
        ...
        _getRelativeOffset: function() { if (this.cssPosition === "relative") { var av = this.currentItem.position(); return { top: av.top - (parseInt(this.helper.css("top"), 10) || 0) + this.scrollParent.scrollTop(), left: av.left - (parseInt(this.helper.css("left"), 10) || 0) + this.scrollParent.scrollLeft() } } else { return { top: 0, left: 0 } } },
        ...
        _clear: function(aw, ay) {
            ...
            if (this.helper[0] === this.currentItem[0]) {
                for (av in this._storedCSS) { if (this._storedCSS[av] === "auto" || this._storedCSS[av] === "static") { this._storedCSS[av] = "" } }
                this.currentItem.css(this._storedCSS);
                this._removeClass(this.currentItem, "ui-sortable-helper")
            } else { this.currentItem.show() }
            ...
            if (this !== this.currentContainer) {
                if (!ay) {
                    az.push(function(aA) { this._trigger("remove", aA, this._uiHash()) });
                    az.push((function(aA) { return function(aB) { aA._trigger("receive", aB, this._uiHash(this)) } }).call(this, this.currentContainer));
                    az.push((function(aA) { return function(aB) { aA._trigger("update", aB, this._uiHash(this)) } }).call(this, this.currentContainer))
                }
            }

            function ax(aC, aA, aB) { return function(aD) { aB._trigger(aC, aD, aA._uiHash(aA)) } }
            for (av = this.containers.length - 1; av >= 0; av--) {
                if (!ay) { az.push(ax("deactivate", this, this.containers[av])) }
                if (this.containers[av].containerCache.over) {
            ...
            if (!ay) {
                for (av = 0; av < az.length; av++) { az[av].call(this, aw) }
    ...
    ak.widget("ui.spinner", {
        ...
        options: { classes: { "ui-spinner": "ui-corner-all", "ui-spinner-down": "ui-corner-br", "ui-spinner-up": "ui-corner-tr" }, culture: null, icons: { down: "ui-icon-triangle-1-s", up: "ui-icon-triangle-1-n" }, incremental: true, max: null, min: null, numberFormat: null, page: 10, step: 1, change: null, spin: null, start: null, stop: null },
        _create: function() {
        ...
        _getCreateOptions: function() {
            var av = this._super();
            var aw = this.element;
            ak.each(["min", "max", "step"], function(ax, ay) { var az = aw.attr(ay); if (az != null && az.length) { av[ay] = az } });
            return av
        },
        _events: {
            keydown: function(av) { if (this._start(av) && this._keydown(av)) { av.preventDefault() } },
            keyup: "_stop",
            ...
            mousewheel: function(av, aw) {
                ...
                this.mousewheelTimer = this._delay(function() { if (this.spinning) { this._stop(av) } }, 100);
                av.preventDefault()
            },
            ...
            "mouseenter .ui-spinner-button": function(av) {
                if (!ak(av.currentTarget).hasClass("ui-state-active")) { return }
        ...
        _start: function(av) {
            if (!this.spinning && this._trigger("start", av) === false) { return false }
        ...
        _repeat: function(aw, av, ax) {
            aw = aw || 500;
            clearTimeout(this.timer);
            this.timer = this._delay(function() { this._repeat(40, av, ax) }, aw);
        ...
        _spin: function(aw, av) {
            ...
            if (!this.spinning || this._trigger("spin", av, { value: ax }) !== false) {
                this._value(ax);
                this.counter++
            }
        },
        _increment: function(av) { var aw = this.options.incremental; if (aw) { return ak.isFunction(aw) ? aw(av) : Math.floor(av * av * av / 50000 - av * av / 500 + 17 * av / 200 + 1) } return 1 },
        _precision: function() { var av = this._precisionOf(this.options.step); if (this.options.min !== null) { av = Math.max(av, this._precisionOf(this.options.min)) } return av },
        _precisionOf: function(aw) {
            var ax = aw.toString(),
                av = ax.indexOf(".");
        ...
        _parse: function(av) { if (typeof av === "string" && av !== "") { av = window.Globalize && this.options.numberFormat ? Globalize.parseFloat(av, 10, this.options.culture) : +av } return av === "" || isNaN(av) ? null : av },
        _format: function(av) { if (av === "") { return "" } return window.Globalize && this.options.numberFormat ? Globalize.format(av, this.options.numberFormat, this.options.culture) : av },
        _refresh: function() { this.element.attr({ "aria-valuemin": this.options.min, "aria-valuemax": this.options.max, "aria-valuenow": this._parse(this.element.val()) }) },
        isValid: function() { var av = this.value(); if (av === null) { return false } return av === this._adjustValue(av) },
        _value: function(ax, av) {
            var aw;
            if (ax !== "") {
                aw = this._parse(ax);
                if (aw !== null) {
                    if (!av) { aw = this._adjustValue(aw) }
                    ax = this._format(aw)
                }
            }
            this.element.val(ax);
    ...
    if (ak.uiBackCompat !== false) { ak.widget("ui.spinner", ak.ui.spinner, { _enhance: function() { this.uiSpinner = this.element.attr("autocomplete", "off").wrap(this._uiSpinnerHtml()).parent().append(this._buttonHtml()) }, _uiSpinnerHtml: function() { return "<span>" }, _buttonHtml: function() { return "<a></a><a></a>" } }) }
    ...
    ak.widget("ui.tabs", {
        version: "1.12.1",
        delay: 300,
        options: { active: null, classes: { "ui-tabs": "ui-corner-all", "ui-tabs-nav": "ui-corner-all", "ui-tabs-panel": "ui-corner-bottom", "ui-tabs-tab": "ui-corner-top" }, collapsible: false, event: "click", heightStyle: "content", hide: null, show: null, activate: null, beforeActivate: null, beforeLoad: null, load: null },
        _isLocal: (function() {
            var av = /#.*$/;
            return function(ax) {
                var az, ay;
                ...
                try { az = decodeURIComponent(az) } catch (aw) {}
                try { ay = decodeURIComponent(ay) } catch (aw) {}
        ...
        _create: function() {
            ...
            if (ak.isArray(av.disabled)) { av.disabled = ak.unique(av.disabled.concat(ak.map(this.tabs.filter(".ui-state-disabled"), function(ax) { return aw.tabs.index(ax) }))).sort() }
            if (this.options.active !== false && this.anchors.length) { this.active = this._findActive(av.active) } else { this.active = ak() }
            this._refresh();
        ...
        _initialActive: function() {
            ...
            if (aw === null) { if (ax) { this.tabs.each(function(ay, az) { if (ak(az).attr("aria-controls") === ax) { aw = ay; return false } }) } if (aw === null) { aw = this.tabs.index(this.tabs.filter(".ui-tabs-active")) } if (aw === null || aw === -1) { aw = this.tabs.length ? 0 : false } }
            if (aw !== false) { aw = this.tabs.index(this.tabs.eq(aw)); if (aw === -1) { aw = av ? false : 0 } }
        ...
        _tabKeydown: function(ax) {
            ...
            if (!ax.ctrlKey && !ax.metaKey) {
                ...
                this.activating = this._delay(function() { this.option("active", av) }, this.delay)
            }
        },
        _panelKeydown: function(av) {
            if (this._handlePageNav(av)) { return }
            if (av.ctrlKey && av.keyCode === ak.ui.keyCode.UP) {
                av.preventDefault();
                this.active.trigger("focus")
            }
        },
        _handlePageNav: function(av) { if (av.altKey && av.keyCode === ak.ui.keyCode.PAGE_UP) { this._activate(this._focusNextTab(this.options.active - 1, false)); return true } if (av.altKey && av.keyCode === ak.ui.keyCode.PAGE_DOWN) { this._activate(this._focusNextTab(this.options.active + 1, true)); return true } },
        ...
        _setOption: function(av, aw) {
            if (av === "active") { this._activate(aw); return }
            this._super(av, aw);
            if (av === "collapsible") { this._toggleClass("ui-tabs-collapsible", null, aw); if (!aw && this.options.active === false) { this._activate(0) } }
        ...
        _processTabs: function() {
            ...
            this.tablist.on("mousedown" + this.eventNamespace, "> li", function(az) { if (ak(this).is(".ui-state-disabled")) { az.preventDefault() } }).on("focus" + this.eventNamespace, ".ui-tabs-anchor", function() { if (ak(this).closest("li").is(".ui-state-disabled")) { this.blur() } });
            this.tabs = this.tablist.find("> li:has(a[href])").attr({ role: "tab", tabIndex: -1 });
            this._addClass(this.tabs, "ui-tabs-tab", "ui-state-default");
            this.anchors = this.tabs.map(function() { return ak("a", this)[0] }).attr({ role: "presentation", tabIndex: -1 });
        ...
        _setOptionDisabled: function(ay) {
            var ax, av, aw;
            if (ak.isArray(ay)) { if (!ay.length) { ay = false } else { if (ay.length === this.anchors.length) { ay = true } } }
            for (aw = 0;
                (av = this.tabs[aw]); aw++) {
                ax = ak(av);
        ...
        _setupHeightStyle: function(av) {
            ...
            if (av === "fill") {
                ...
                this.panels.each(function() { ak(this).height(Math.max(0, ax - ak(this).innerHeight() + ak(this).height())) }).css("overflow", "auto")
            } else {
                if (av === "auto") {
                    ax = 0;
                    this.panels.each(function() { ax = Math.max(ax, ak(this).height("").height()) }).height(ax)
                }
            }
        },
        _eventHandler: function(av) {
            var aE = this.options,
                ...
                aD = { oldTab: az, oldPanel: aB, newTab: aw ? ak() : ay, newPanel: ax };
            av.preventDefault();
        ...
        _toggle: function(aB, aA) {
            ...
            function aw() {
                ...
                if (av.length && az.options.show) { az._show(av, az.options.show, ax) } else {
                    av.show();
                    ax()
                }
            }
            ...
            if (av.length && ay.length) { aA.oldTab.attr("tabIndex", -1) } else { if (av.length) { this.tabs.filter(function() { return ak(this).attr("tabIndex") === 0 }).attr("tabIndex", -1) } }
        ...
        _getIndex: function(av) { if (typeof av === "string") { av = this.anchors.index(this.anchors.filter("[href$='" + ak.ui.escapeSelector(av) + "']")) } return av },
        _destroy: function() {
            if (this.xhr) { this.xhr.abort() }
            this.tablist.removeAttr("role").off(this.eventNamespace);
            this.anchors.removeAttr("role tabIndex").removeUniqueId();
            this.tabs.add(this.panels).each(function() { if (ak.data(this, "ui-tabs-destroy")) { ak(this).remove() } else { ak(this).removeAttr("role tabIndex aria-live aria-busy aria-selected aria-labelledby aria-hidden aria-expanded") } });
            this.tabs.each(function() {
                var av = ak(this),
                    aw = av.data("ui-tabs-aria-controls");
                if (aw) { av.attr("aria-controls", aw).removeData("ui-tabs-aria-controls") } else { av.removeAttr("aria-controls") }
            });
            this.panels.show();
        ...
        enable: function(av) {
            ...
            if (aw === false) { return }
            if (av === undefined) { aw = false } else { av = this._getIndex(av); if (ak.isArray(aw)) { aw = ak.map(aw, function(ax) { return ax !== av ? ax : null }) } else { aw = ak.map(this.tabs, function(ax, ay) { return ay !== av ? ay : null }) } }
            this._setOptionDisabled(aw)
        },
        disable: function(av) {
            var aw = this.options.disabled;
            if (aw === true) { return }
            if (av === undefined) { aw = true } else { av = this._getIndex(av); if (ak.inArray(av, aw) !== -1) { return } if (ak.isArray(aw)) { aw = ak.merge([av], aw).sort() } else { aw = [av] } }
            this._setOptionDisabled(aw)
        },
        load: function(ay, aC) {
            ...
            var aB = this,
                ...
                aA = { tab: az, panel: aw },
                av = function(aE, aD) {
                    if (aD === "abort") { aB.panels.stop(false, true) }
            ...
            if (this.xhr && this.xhr.statusText !== "canceled") {
                ...
                }).fail(function(aE, aD) { setTimeout(function() { av(aE, aD) }, 1) })
            }
        },
        _ajaxSettings: function(av, ay, ax) { var aw = this; return { url: av.attr("href").replace(/#.*$/, ""), beforeSend: function(aA, az) { return aw._trigger("beforeLoad", ay, ak.extend({ jqXHR: aA, ajaxSettings: az }, ax)) } } },
        _getPanelForTab: function(av) { var aw = ak(av).attr("aria-controls"); return this.element.find(this._sanitizeSelector("#" + aw)) }
    });
    if (ak.uiBackCompat !== false) {
    ...
    ak.widget("ui.tooltip", {
        version: "1.12.1",
        options: { classes: { "ui-tooltip": "ui-corner-all ui-widget-shadow" }, content: function() { var av = ak(this).attr("title") || ""; return ak("<a>").text(av).html() }, hide: true, items: "[title]:not([disabled])", position: { my: "left top+15", at: "left bottom", collision: "flipfit flip" }, show: true, track: false, close: null, open: null },
        ...
        _removeDescribedBy: function(ax) {
            ...
            aw = ak.trim(aw.join(" "));
            if (aw) { ax.attr("aria-describedby", aw) } else { ax.removeAttr("aria-describedby") }
        },
        _create: function() {
        ...
        _disable: function() {
            ...
            this.disabledTitles = this.disabledTitles.add(this.element.find(this.options.items).addBack().filter(function() { var aw = ak(this); if (aw.is("[title]")) { return aw.data("ui-tooltip-title", aw.attr("title")).removeAttr("title") } }))
        },
        _enable: function() {
            this.disabledTitles.each(function() { var av = ak(this); if (av.data("ui-tooltip-title")) { av.attr("title", av.data("ui-tooltip-title")) } });
            this.disabledTitles = ak([])
        },
        open: function(aw) {
            var av = this,
        ...
        _updateContent: function(aA, az) {
            ...
            ay = av.call(aA[0], function(aB) {
                ax._delay(function() {
                    if (!aA.data("ui-tooltip-open")) { return }
                    if (az) { az.type = aw }
                    this._open(az, aA, aB)
                })
            });
        ...
        _open: function(aw, az, aA) {
            ...
            if (!aA) { return }
            av = this._find(az);
            if (av) { av.tooltip.find(".ui-tooltip-content").html(aA); return }
            if (az.is("[title]")) { if (aw && aw.type === "mouseover") { az.attr("title", "") } else { az.removeAttr("title") } }
            av = this._tooltip(az);
            aD = av.tooltip;
            ...
            if (this.options.track && aw && /^mouse/.test(aw.type)) {
                this._on(this.document, { mousemove: ay });
                ay(aw)
        ...
        close: function(aw) {
            var ay, av = this,
                ...
                ax = this._find(az);
            if (!ax) { az.removeData("ui-tooltip-open"); return }
            ay = ax.tooltip;
        ...
        _find: function(av) { var aw = av.data("ui-tooltip-id"); return aw ? this.tooltips[aw] : null },
        _removeTooltip: function(av) {
            av.remove();
            delete this.tooltips[av.attr("id")]
        },
        _appendTo: function(aw) { var av = aw.closest(".ui-front, dialog"); if (!av.length) { av = this.document[0].body } return av },
        _destroy: function() {
            var av = this;
            ak.each(this.tooltips, function(az, ay) {
                ...
                if (aw.data("ui-tooltip-title")) {
                    if (!aw.attr("title")) { aw.attr("title", aw.data("ui-tooltip-title")) }
    ...
    if (ak.uiBackCompat !== false) { ak.widget("ui.tooltip", ak.ui.tooltip, { options: { tooltipClass: null }, _tooltip: function() { var av = this._superApply(arguments); if (this.options.tooltipClass) { av.tooltip.addClass(this.options.tooltipClass) } return av } }) }
    var D = ak.ui.tooltip
}));